...
<SplendidCRM:ListHeader SubPanel="divNotesMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divNotesMassUpdate" style='<%= "display:" + (CookieValue("divNotesMassUpdate") != "1" ? "inline" : "none") %>'>
