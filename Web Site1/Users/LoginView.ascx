							...
							<asp:Table ID="tblUser" Visible="<%# !Security.IsWindowsAuthentication() %>" Width="100%" BorderWidth="0" CellPadding="0" CellSpacing="2" HorizontalAlign="Center" Runat="server">
								<asp:TableRow>
									<asp:TableCell ColumnSpan="2" style="font-size: 12px; padding-top: 5px;">
										<asp:Label ID="lblInstructions" Visible="<%# !Security.IsWindowsAuthentication() %>" Text='<%# L10n.Term(".NTC_LOGIN_MESSAGE") %>' Runat="server" />
									</asp:TableCell>
								</asp:TableRow>
								...
								<asp:TableRow>
									...
									<asp:TableCell Width="70%">
										<asp:TextBox ID="txtUSER_NAME" Width="180px" Runat="server" /> &nbsp;<%# (Sql.IsEmptyString(Application["CONFIG.default_user_name"]) ? String.Empty : "(" + Sql.ToString(Application["CONFIG.default_user_name"]) + ")") %>
									</asp:TableCell>
								</asp:TableRow>
								<asp:TableRow>
									<asp:TableCell Width="30%" CssClass="dataLabel"><%# L10n.Term("Users.LBL_PASSWORD") %></asp:TableCell>
									<asp:TableCell Width="70%">
										<asp:TextBox ID="txtPASSWORD" Width="180px" TextMode="Password" Runat="server" /> &nbsp;<%# (Sql.IsEmptyString(Application["CONFIG.default_password"]) ? String.Empty : "(" + Sql.ToString(Application["CONFIG.default_password"]) + ")") %>
									</asp:TableCell>
								</asp:TableRow>
							</asp:Table>
