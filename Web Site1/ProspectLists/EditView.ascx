...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="ProspectLists" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
...
<asp:UpdatePanel UpdateMode="Conditional" runat="server">
	...
	<asp:Panel ID="pnlDynamicSQL" runat="server">
		...
		<SplendidCRM:QueryBuilder ID="ctlQueryBuilder" Modules="Contacts,Leads,Prospects,Users" UserSpecific="false" ShowRelated="true" PrimaryKeyOnly="true" Runat="Server" />
	</asp:Panel>
