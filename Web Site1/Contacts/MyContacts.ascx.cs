...
namespace SplendidCRM.Contacts
{
	...
	/// </summary>
	public class MyContacts : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			{
				string sSQL;
				sSQL = "  from vwCONTACTS_MyList" + ControlChars.CrLf;
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyContacts", dt);
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Contacts.MyContacts", arrSelectFields);
		}
		#endregion
	}
}
