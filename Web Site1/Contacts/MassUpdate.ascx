...
<SplendidCRM:ListHeader SubPanel="divContactsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divContactsMassUpdate" style='<%= "display:" + (CookieValue("divContactsMassUpdate") != "1" ? "inline" : "none") %>'>
