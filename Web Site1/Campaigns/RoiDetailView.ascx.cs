								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											ctlDynamicLinks  .AppendButtons(m_sMODULE + ".RoiLinkView"  , Sql.ToGuid(rdr["ASSIGNED_USER_ID"]), rdr);
										}
										else
										{
											...
											// 04/04/2008 Paul.  Add the ROI links.
											ctlDynamicLinks  .AppendButtons(m_sMODULE + ".RoiLinkView"  , Guid.Empty, null);
