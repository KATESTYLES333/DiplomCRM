		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											ctlDynamicLinks  .AppendButtons(m_sMODULE + ".TrackLinkView"  , Sql.ToGuid(rdr["ASSIGNED_USER_ID"]), rdr);
										...
										else
										{
											...
											// 04/04/2008 Paul.  Add the ROI links.
											ctlDynamicLinks  .AppendButtons(m_sMODULE + ".TrackLinkView"  , Guid.Empty, null);
				...
				else
				{
					...
					Page.Items["NAME"] = ctlModuleHeader.Title;
				}
