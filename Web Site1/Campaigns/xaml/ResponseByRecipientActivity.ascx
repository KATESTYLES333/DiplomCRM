<%@ Control CodeBehind="ResponseByRecipientActivity.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Campaigns.xaml.ResponseByRecipientActivity" %>
...
<asp:Repeater DataSource="<%# nlDataRows %>" runat="server">
	...
	<FooterTemplate>
				...
				<Canvas x:Name="legend" Canvas.Top="0" Canvas.Left="<%# 190 + nGridWidth + nGridWidth / nAxis_xData_length + 1 %>" Width="150" Height="<%# nGridHeight %>">
