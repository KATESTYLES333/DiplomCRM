<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="roi.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Campaigns.Roi" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="DetailView" Src="RoiDetailView.ascx" %>
