<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="track.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Campaigns.Track" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="DetailView" Src="TrackDetailView.ascx" %>
	<SplendidCRM:DetailView ID="ctlDetailView" Visible='<%# SplendidCRM.Security.GetUserAccess("Campaigns", "view") >= 0 %>' Runat="Server" />
