...
{
	/// <summary>
	///		Summary description for MyAccounts.
	/// </summary>
	public class MyAccounts : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			{
				string sSQL;
				sSQL = "  from vwACCOUNTS_MyList" + ControlChars.CrLf;
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyAccounts", dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( this.Visible && !Sql.IsEmptyString(sDetailView) )
			{
				...
				vwFields.RowFilter = "CONTROL_NAME = '~/Accounts/MyAccounts'";
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Accounts.MyAccounts", arrSelectFields);
		}
		#endregion
	}
}
