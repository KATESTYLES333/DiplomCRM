			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbTransaction trn = Sql.BeginTransaction(con) )
				{
					...
					try
					{
						...
						SqlProcs.spPROJECT_TASKS_Update(ref gPROJECT_TASK_ID1, gDEMO_ID, "Communicate to stakeholders"    , String.Empty, new DateTime(2007, 11,  8), new DateTime(2007, 11,  1), gPROJECT_ID, String.Empty, "Schedule individual meetings with Will, Max, and Sarah."              , 0, 0, Guid.Empty, false, 0.0f, 0.0f, 0, 100, Guid.Empty, String.Empty, trn);
						SqlProcs.spPROJECT_TASKS_Update(ref gPROJECT_TASK_ID2, gDEMO_ID, "Create draft of the plan"       , String.Empty, new DateTime(2007, 11, 20), new DateTime(2007, 11,  5), gPROJECT_ID, String.Empty, "Schedule individual meetings with Will, Max, and Sarah."              , 0, 0, Guid.Empty, false, 0.0f, 0.0f, 0,  38, Guid.Empty, String.Empty, trn);
						SqlProcs.spPROJECT_TASKS_Update(ref gPROJECT_TASK_ID3, gDEMO_ID, "Field work for collecting data.", String.Empty, new DateTime(2007, 11, 13), new DateTime(2007, 11,  5), gPROJECT_ID, String.Empty, "We need to get approval from all stakeholders on the plan"            , 0, 0, Guid.Empty, false, 0.0f, 0.0f, 0,  75, Guid.Empty, String.Empty, trn);
						SqlProcs.spPROJECT_TASKS_Update(ref gPROJECT_TASK_ID4, gDEMO_ID, "Create draft of the plan"       , String.Empty, new DateTime(2007, 11, 19), new DateTime(2007, 11, 12), gPROJECT_ID, String.Empty, "Schedule the meeting with the head of business units to solicit help.", 0, 0, Guid.Empty, false, 0.0f, 0.0f, 0,   0, Guid.Empty, String.Empty, trn);
						SqlProcs.spPROJECT_TASKS_Update(ref gPROJECT_TASK_ID5, gDEMO_ID, "Gather data from meetings"      , String.Empty, new DateTime(2007, 11, 20), new DateTime(2007, 11, 20), gPROJECT_ID, String.Empty, "Need to organize the data and put it in the right spreadsheet."       , 0, 0, Guid.Empty, false, 0.0f, 0.0f, 0,   0, Guid.Empty, String.Empty, trn);
						trn.Commit();
					}
					catch(Exception ex)
					{
