...
{
	/// <summary>
	///		Summary description for MyCalls.
	/// </summary>
	public class MyCalls : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			{
				string sSQL;
				sSQL = "  from vwCALLS_MyList" + ControlChars.CrLf;
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyCalls", dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( this.Visible && !Sql.IsEmptyString(sDetailView) )
			{
				...
				vwFields.RowFilter = "CONTROL_NAME = '~/Calls/MyCalls'";
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, m_sMODULE + ".MyCalls", arrSelectFields);
		}
		#endregion
	}
}
