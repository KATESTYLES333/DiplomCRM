...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<iframe width="100%" height="800" frameborder="0"
		src="<%= String.Format(Sql.ToString(Application["CONFIG.sugar_university"]), Sql.ToString(Application["CONFIG.sugar_version"]), Sql.ToString(Session["USER_SETTINGS/CULTURE"]).Replace("-", "_")) %>">
	</iframe>
</asp:Content>
