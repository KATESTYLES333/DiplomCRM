...
<span class="body">
	<p style="margin-top: 15px;"><b>SplendidCRM <%= Application["CONFIG.service_level"] %> Version <asp:Label ID="lblBuildNumber" Runat="server" /></b></p>

	<p>Copyright &copy; 2005 -2014 <asp:HyperLink NavigateUrl="http://www.splendidcrm.com" Target="_blank" CssClass="body" Text="SplendidCRM Software, Inc." runat="server" /> All Rights Reserved.</p>
	<asp:Label ID="lblLicense" runat="server" />
	
	<p style="margin-top: 15px;"><b>SplendidCRM Software, Inc.</b></p>
	<p>Web:  <asp:HyperLink NavigateUrl="http://www.splendidcrm.com" Target="_blank" CssClass="body" Text="http://www.splendidcrm.com" runat="server" /><br />
	Sales:   <asp:HyperLink NavigateUrl="mailto:sales@splendidcrm.com"               CssClass="body" Text="sales@splendidcrm.com"      runat="server" /><br />
	Support: <asp:HyperLink NavigateUrl="mailto:support@splendidcrm.com"             CssClass="body" Text="support@splendidcrm.com"    runat="server" /><br />
	Phone: (919) 617-1258<br />
	</p>
	
	<p style="margin-top: 15px;"><b>Open-Source libraries</b></p>
