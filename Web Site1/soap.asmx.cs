	...
	public class soap : System.Web.Services.WebService
	{
		...
		*/
		...
		public string create_contact(string user_name, string password, string first_name, string last_name, string email_address)
		{
			...
			SqlProcs.spCONTACTS_New(ref gID, first_name, last_name, String.Empty, email_address, Security.USER_ID, Security.TEAM_ID, String.Empty);
			return "1";
		}
		...
		public string create_lead(string user_name, string password, string first_name, string last_name, string email_address)
		{
			...
			Guid gID = Guid.Empty;
			// 01/16/2012 Paul.  Assigned User ID and Team ID are now parameters. 
			SqlProcs.spLEADS_New(ref gID, first_name, last_name, String.Empty, email_address, Security.USER_ID, Security.TEAM_ID, String.Empty);
			return "1";
		}
		...
		public string create_account(string user_name, string password, string name, string phone, string website)
		{
			...
			Guid gID = Guid.Empty;
			// 01/16/2012 Paul.  Assigned User ID and Team ID are now parameters. 
			SqlProcs.spACCOUNTS_New(ref gID, name, phone, website, Security.USER_ID, Security.TEAM_ID, String.Empty);
			return "1";
		}
		...
		public string create_opportunity(string user_name, string password, string name, string amount)
		{
			...
			SqlProcs.spOPPORTUNITIES_New(ref gID, Guid.Empty, name, Sql.ToDecimal(amount), Guid.Empty, DateTime.MinValue, String.Empty, Security.USER_ID, Security.TEAM_ID, String.Empty, Guid.Empty);
			return "1";
		}
		...
		public string create_case(string user_name, string password, string name)
		{
			...
			// 01/16/2012 Paul.  Assigned User ID and Team ID are now parameters. 
			// 05/01/2013 Paul.  Add Contacts field to support B2C. 
			SqlProcs.spCASES_New(ref gID, name, String.Empty, Guid.Empty, Security.USER_ID, Security.TEAM_ID, String.Empty, Guid.Empty);
			return "1";
		}
		#endregion
		...
		public contact_detail[] search(string user_name, string password, string name)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					cmd.CommandText += Contacts.SearchContacts.UnifiedSearch(name, cmd);
					//     + " where 1 = 1                                  " + ControlChars.CrLf
					...
					cmd.CommandText += Leads.SearchLeads.UnifiedSearch(name, cmd);
					//     + " where 1 = 1                                  " + ControlChars.CrLf
					...
					cmd.CommandText += Accounts.SearchAccounts.UnifiedSearch(name, cmd);
					//     + " where 1 = 1                                  " + ControlChars.CrLf
					...
					cmd.CommandText += Cases.SearchCases.UnifiedSearch(name, cmd);
					//     + " where 1 = 1                                  " + ControlChars.CrLf
					...
					cmd.CommandText += Opportunities.SearchOpportunities.UnifiedSearch(name, cmd);
					//     + " where 1 = 1                                  " + ControlChars.CrLf
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					foreach ( string sModule in modules )
					{
						if ( sModule == "Contacts" )
						{
							...
							cmd.CommandText += sSQL;
							Security.Filter(cmd, "Contacts", "list");
							cmd.CommandText += Contacts.SearchContacts.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Leads" )
						{
							...
							cmd.CommandText += sSQL;
							Security.Filter(cmd, "Leads", "list");
							cmd.CommandText += Leads.SearchLeads.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Accounts" )
						{
							...
							cmd.CommandText += sSQL;
							Security.Filter(cmd, "Accounts", "list");
							cmd.CommandText += Accounts.SearchAccounts.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Cases" )
						{
							...
							cmd.CommandText += sSQL;
							Security.Filter(cmd, "Cases", "list");
							cmd.CommandText += Cases.SearchCases.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Opportunities" )
						{
							...
							cmd.CommandText += sSQL;
							Security.Filter(cmd, "Opportunities", "list");
							cmd.CommandText += Opportunities.SearchOpportunities.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Bugs" )
						{
							...
							cmd.CommandText += Bugs.SearchBugs.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Projects" || sModule == "Project" )
						{
							...
							cmd.CommandText += Projects.SearchProjects.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						else if ( sModule == "Orders" )
						{
							...
							cmd.CommandText += Orders.SearchOrders.UnifiedSearch(search_string, cmd);
							//     + " where 1 = 1                                  " + ControlChars.CrLf
						...
						if ( bIsWriteable )
						{
							...
							else if ( name_value_list[j].name.ToUpper() == "ACCOUNT_NAME" && String.Compare(module_name, "Contacts", true) == 0 )
							{
								...
								if ( !Sql.IsEmptyString(sACCOUNT_NAME) )
								{
									...
									{
										// 01/16/2012 Paul.  Assigned User ID and Team ID are now parameters. 
										SqlProcs.spACCOUNTS_New(ref gACCOUNT_ID, sACCOUNT_NAME, String.Empty, string.Empty, Security.USER_ID, Security.TEAM_ID, String.Empty);
									}
									if ( !Sql.IsEmptyGuid(gACCOUNT_ID) )
					...
					switch ( sMODULE2 )
					{
						...
						case "Users":
						{
							...
							if ( Sql.IsEmptyGuid(gUSER_ID) )
								SqlProcs.spCONTACTS_USERS_Delete(gCONTACT_ID, Security.USER_ID);
							else
