<%@ Control CodeBehind="OppByLeadSource.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Dashboard.SilverlightCharts.OppByLeadSource" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDashboardOpportunityByLeadSource">
	...
	<SplendidCRM:DashletHeader ID="ctlDashletHeader" Title="Dashboard.LBL_LEAD_SOURCE_FORM_TITLE" DivEditName="pbls_edit2" ShowCommandTitles="true" Runat="Server" />
	<p>
	<div ID="pbls_edit2" style="DISPLAY: <%= bShowEditDialog ? "inline" : "none" %>">
		<asp:Table SkinID="tabFrame" HorizontalAlign="Center" CssClass="chartForm" runat="server">
			<asp:TableRow>
				...
				<asp:TableCell VerticalAlign="top" HorizontalAlign="Right">
					...
					<asp:Button ID="btnCancel" UseSubmitBehavior="false" OnClientClick="toggleDisplay('pbls_edit2'); return false;" CssClass="button" Text='<%# "  " + L10n.Term(".LBL_CANCEL_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term(".LBL_CANCEL_BUTTON_TITLE") %>' AccessKey='<%# L10n.AccessKey(".LBL_CANCEL_BUTTON_KEY") %>' runat="server" />
				</asp:TableCell>
			</asp:TableRow>
		</asp:Table>
	</div>
	...
	<p align="center">
<%@ Register TagPrefix="SplendidCRM" Tagname="OppByLeadSource" Src="~/Opportunities/xaml2/OppByLeadSource.ascx" %>
<script type="text/xaml" id="xamlOppByLeadSource2"><?xml version="1.0"?>
<SplendidCRM:OppByLeadSource Visible="true" Runat="Server" />
</script>
	<div id="hostOppByLeadSource2" style="width: 800x; height: 400px; padding-bottom: 2px;" align="center"></div>
<SplendidCRM:InlineScript runat="server">
		<script type="text/javascript">
		Silverlight.createObjectEx({
			source: "<%= Application["rootURL" ] %>ClientBin/SilverlightContainer.xap",
			parentElement: document.getElementById("hostOppByLeadSource2"),
			...
			initParams: "xamlContent=xamlOppByLeadSource2",
			context: "none"
		});
		</script>
