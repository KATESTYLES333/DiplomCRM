...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Administration" Title="DynamicLayout.LBL_EDIT_VIEW_LAYOUT" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
