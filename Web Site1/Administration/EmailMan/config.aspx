<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="config.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.EmailMan.Config" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="EmailMan" Title="EmailMan.LBL_CAMPAIGN_EMAIL_SETTINGS" EnableModuleLabel="false" EnablePrint="false" EnableHelp="true" Runat="Server" />
