...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="BusinessRules" Title=".moduleList.Home" EnablePrint="false" HelpName="Wizard" EnableHelp="true" Visible="<%# ShowHeader %>" Runat="Server" />

	<asp:UpdatePanel UpdateMode="Conditional" runat="server">
		<ContentTemplate>
			<p>
			<%@ Register TagPrefix="SplendidCRM" Tagname="DynamicButtons" Src="~/_controls/DynamicButtons.ascx" %>
			<SplendidCRM:DynamicButtons ID="ctlDynamicButtons" Visible="<%# ShowTopButtons && !PrintView %>" ShowRequired="true" Runat="Server" />
			...
			<SplendidCRM:DynamicButtons ID="ctlFooterButtons" Visible="<%# ShowBottomButtons && !PrintView %>" ShowRequired="false" Runat="Server" />
