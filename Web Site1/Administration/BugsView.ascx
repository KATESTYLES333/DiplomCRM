...
<div id="divBugsView" visible='<%# SplendidCRM.Security.AdminUserAccess("Releases", "access") >= 0 %>' runat="server">
	<p>
	...
	<asp:Table Width="100%" CssClass="tabDetailView2" runat="server">
		<asp:TableRow>
			...
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2">
				<asp:Image SkinID="NumberSequences" AlternateText='<%# L10n.Term("Administration.LBL_MANAGE_NUMBER_SEQUENCES") %>' Runat="server" />
				&nbsp;
				<asp:HyperLink Text='<%# L10n.Term("Administration.LBL_MANAGE_NUMBER_SEQUENCES") %>' NavigateUrl="~/Administration/NumberSequences/default.aspx" CssClass="tabDetailViewDL2Link" Runat="server" />
			</asp:TableCell>
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2"><asp:Label ID="Label1" Text='<%# L10n.Term("Administration.LBL_NUMBER_SEQUENCES") %>' runat="server" /></asp:TableCell>
		</asp:TableRow>
	</asp:Table>
	</p>
