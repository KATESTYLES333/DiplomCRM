			...
			try
			{
				...
				if ( !IsPostBack )
				{
					...
					if ( Sql.IsEmptyGuid(gID) )
					{
						...
						if ( sEMAIL_TYPE == "archived" )
							ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("Emails.LBL_ARCHIVED_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>";
						else
							ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("Emails.LBL_COMPOSE_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>";
						// 04/16/2006 Paul.  The subject is not required. 
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											switch ( sEMAIL_TYPE )
											{
												case "archived":
													...
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("Emails.LBL_ARCHIVED_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
												case "out":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("Emails.LBL_LIST_FORM_SENT_TITLE") + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
												default:
													sEMAIL_TYPE = "draft";
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("Emails.LBL_COMPOSE_MODULE_NAME" ) + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
											}
											// 04/16/2006 Paul.  The subject is not required. 
											//lblNAME_REQUIRED .Visible = (sEMAIL_TYPE == "archived");
