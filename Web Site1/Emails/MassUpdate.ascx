...
<SplendidCRM:ListHeader SubPanel="divEmailsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divEmailsMassUpdate" style='<%= "display:" + (CookieValue("divEmailsMassUpdate") != "1" ? "inline" : "none") %>'>
