<%@ Control CodeBehind="Contacts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Emails.Contacts" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:ListHeader SubPanel="divEmailsContacts" Title="Contacts.LBL_MODULE_NAME" Runat="Server" />

<div id="divEmailsContacts" style='<%= "display:" + (CookieValue("divEmailsContacts") != "1" ? "inline" : "none") %>'>
