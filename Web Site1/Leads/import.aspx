<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Leads.Import" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ImportView ID="ctlImportView" Module="Leads" Visible='<%# SplendidCRM.Security.GetUserAccess("Leads", "import") >= 0 %>' Runat="Server" />
