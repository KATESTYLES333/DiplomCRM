...
<SplendidCRM:ListHeader SubPanel="divLeadsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divLeadsMassUpdate" style='<%= "display:" + (CookieValue("divLeadsMassUpdate") != "1" ? "inline" : "none") %>'>
