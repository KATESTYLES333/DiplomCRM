/* Copyright (C) 2013-2015 SplendidCRM Software, Inc. All Rights Reserved. 
		...
		for ( var i = 0; i < result.length; i++ )
		{
			...
			if ( arrDetailViewRelationship.length == 0 || arrValidModules[sMODULE_NAME] !== undefined )
			{
				if ( (nDisplayedTabs < nMaxTabs - 1) || (nDisplayedTabs == nMaxTabs - 1 && (bActiveHighlighted || (sMODULE_NAME == sMENU_ACTIVE_MODULE))) )
				{
					...
					//}
					ctlActiveMenu.ActionsPopup(sLayoutPanel, sActionsPanel, sMODULE_NAME, sDISPLAY_NAME, tabMenuInner, td);
				}
				else
				{
...
TabMenuUI_Atlantic.prototype.ActionsPopup = function(sLayoutPanel, sActionsPanel, sMODULE_NAME, sDISPLAY_NAME, ctlTabMenu_tabMenuInner, tdMenuInner)
{
	try
	{
