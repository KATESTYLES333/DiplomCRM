...
<SplendidCRM:ListHeader SubPanel="divDocumentsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divDocumentsMassUpdate" style='<%= "display:" + (CookieValue("divDocumentsMassUpdate") != "1" ? "inline" : "none") %>'>
