	...
	public class NewRecord : NewRecordControl
	{
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			SqlProcs.spMEETINGS_Update
				...
				, sPARENT_TYPE
				, gPARENT_ID                                                  // 01/31/2006 Paul.  Bug Fix, should be PARENT_ID, not APARENT_ID. 
				...
				,(new DynamicControl(this, "EMAIL_REMINDER_TIME").IntegerValue > 0 ? new DynamicControl(this, "EMAIL_REMINDER_TIME").IntegerValue : -1)
				...
				,(new DynamicControl(this, "SMS_REMINDER_TIME"  ).IntegerValue > 0 ? new DynamicControl(this, "SMS_REMINDER_TIME").IntegerValue : -1)
				, trn
				);
		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			try
			{
				...
				{
					Response.Redirect("~/Meetings/edit.aspx?PARENT_ID=" + PARENT_ID.ToString());
				}
				else if ( Command != null )
				{
					Command(sender, e);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if ( !bIsPostBack )
				{
					...
					// 04/20/2011 Paul.  Default value for duration is 0 minutes. 
					new DynamicControl(this, "DURATION_MINUTES").SelectedValue = "0";
					// 04/20/2011 Paul.  Default to 1 hour. 
