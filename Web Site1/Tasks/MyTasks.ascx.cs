...
namespace SplendidCRM.Tasks
{
	...
	/// </summary>
	public class MyTasks : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			{
				string sSQL;
				sSQL = "  from vwTASKS_MyList" + ControlChars.CrLf;
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyTasks", dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( this.Visible && !Sql.IsEmptyString(sDetailView) )
			{
				...
				vwFields.RowFilter = "CONTROL_NAME = '~/Tasks/MyTasks'";
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Tasks.MyTasks", arrSelectFields);
		}
		#endregion
	}
}
