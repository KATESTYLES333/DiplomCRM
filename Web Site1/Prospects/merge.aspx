<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="merge.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Prospects.Merge" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:MergeView ID="ctlMergeView" Module="Prospects" Visible='<%# SplendidCRM.Security.GetUserAccess("Prospects", "edit") >= 0 %>' Runat="Server" />
