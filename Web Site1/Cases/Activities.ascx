...
<SplendidCRM:ListHeader SubPanel="divCasesActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />
	...
	<SplendidCRM:SplendidGrid id="grdOpen" SkinID="grdSubPanelView" AllowPaging="<%# !PrintView %>" EnableViewState="true" runat="server">
		<Columns>
			...
			<asp:TemplateColumn  HeaderText="" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
				<ItemTemplate>
					<asp:HyperLink Visible='<%# Sql.ToString(DataBinder.Eval(Container.DataItem, "ACTIVITY_TYPE")) == "Emails" && SplendidCRM.Security.GetUserAccess(Sql.ToString(DataBinder.Eval(Container.DataItem, "ACTIVITY_TYPE")), "view", Sql.ToGuid(DataBinder.Eval(Container.DataItem, "ACTIVITY_ASSIGNED_USER_ID"))) >= 0 %>' NavigateUrl='<%# "~/Emails/edit.aspx?type=reply&DuplicateID=" + Eval("ACTIVITY_ID") + "&CASE_ID=" + Eval("CASE_ID") %>' CssClass="listViewTdToolsS1" Runat="server">
...
<SplendidCRM:ListHeader SubPanel="divCasesActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />
