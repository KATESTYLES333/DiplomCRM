...
<SplendidCRM:ListHeader SubPanel="divCasesMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divCasesMassUpdate" style='<%= "display:" + (CookieValue("divCasesMassUpdate") != "1" ? "inline" : "none") %>'>
