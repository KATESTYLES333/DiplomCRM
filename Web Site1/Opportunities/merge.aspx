<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="merge.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Opportunities.Merge" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:MergeView ID="ctlMergeView" Module="Opportunities" Visible='<%# SplendidCRM.Security.GetUserAccess("Opportunities", "edit") >= 0 %>' Runat="Server" />
