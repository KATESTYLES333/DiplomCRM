...
<div id="divDetailView" runat="server">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Opportunities" EnablePrint="true" HelpName="DetailView" EnableHelp="true" EnableFavorites="true" Runat="Server" />
