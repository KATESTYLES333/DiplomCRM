...
<div id="divListView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="EmailClient" Title="<%# Security.EXCHANGE_ALIAS %>" EnableModuleLabel="true" EnablePrint="false" HelpName="index" EnableHelp="true" Runat="Server" />
									...
									<ContentTemplate>
										<SplendidCRM:SplendidGrid id="grdMain" SkinID="grdListView" AllowPaging="true" EnableViewState="true" runat="server">
											<Columns>
												...
												<asp:TemplateColumn     HeaderText="EmailClient.LBL_LIST_FROM"      SortExpression="FROM" ItemStyle-Width="20%" ItemStyle-Wrap="false">
