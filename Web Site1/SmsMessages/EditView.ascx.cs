			...
			try
			{
				...
				if ( !IsPostBack )
				{
					...
					if ( Sql.IsEmptyGuid(gID) )
					{
						...
						if ( sSMS_TYPE == "archived" )
							ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_ARCHIVED_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>";
						else
							ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_NEW_FORM_TITLE") + "</a><span class=\"pointer\">&raquo;</span>";
								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											{
												case "archived":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_ARCHIVED_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
												case "out":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_LIST_FORM_SENT_TITLE") + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
												default:
													sSMS_TYPE = "draft";
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_NEW_FORM_TITLE" ) + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
											}
											ctlDATE_START.Visible = (sSMS_TYPE == "archived");
											lblDATE_START.Visible = (sSMS_TYPE == "archived");
