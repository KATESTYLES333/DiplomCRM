								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											{
												case "archived":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_ARCHIVED_MODULE_NAME") + "</a><span class=\"pointer\">&raquo;</span>" + ctlModuleHeader.Title;
													break;
												case "inbound":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_INBOUND_TITLE") + "</a><span class=\"pointer\">&raquo;</span>" + ctlModuleHeader.Title;
													...
													break;
												case "out":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_LIST_FORM_SENT_TITLE") + "</a><span class=\"pointer\">&raquo;</span>" + ctlModuleHeader.Title;
												...
												default:
													sEMAIL_TYPE = "draft";
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("SmsMessages.LBL_NEW_FORM_TITLE" ) + "</a><span class=\"pointer\">&raquo;</span>" + ctlModuleHeader.Title;
