<%@ Page language="c#" MasterPageFile="~/ListView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.SmsMessages.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ListView ID="ctlListView" Visible='<%# SplendidCRM.Security.GetUserAccess("SmsMessages", "list") >= 0 %>' Runat="Server" />
