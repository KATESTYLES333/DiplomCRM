	...
	public class ProjectTasks : SubPanelControl
	{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					else
					{
						...
						sSQL = "select " + Sql.FormatSelectFields(arrSelectFields)
						     + "  from vwPROJECTS_PROJECT_TASKS" + ControlChars.CrLf;
						cmd.CommandText = sSQL;
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules("Project." + m_sMODULE, dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( !IsPostBack )
			{
				...
				ctlDynamicButtons.AppendButtons("Project." + m_sMODULE, gASSIGNED_USER_ID, gID);
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Project." + m_sMODULE, arrSelectFields);
			// 04/28/2008 Paul.  Make use of dynamic buttons. 
			if ( IsPostBack )
				ctlDynamicButtons.AppendButtons("Project." + m_sMODULE, Guid.Empty, Guid.Empty);
		}
		#endregion
	}
}
