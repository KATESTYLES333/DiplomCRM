								...
								using ( IDbTransaction trn = Sql.BeginTransaction(con) )
								{
									try
									{
										while ( stk.Count > 0 )
										{
											...
											// 01/13/2010 Paul.  New Project fields in SugarCRM. 
											SqlProcs.spPROJECTS_MassUpdate(sIDs, ctlMassUpdate.ASSIGNED_USER_ID, ctlMassUpdate.PRIMARY_TEAM_ID, ctlMassUpdate.TEAM_SET_LIST, ctlMassUpdate.ADD_TEAM_SET, ctlMassUpdate.START_DATE, ctlMassUpdate.END_DATE, ctlMassUpdate.STATUS, ctlMassUpdate.PRIORITY, trn);
										}
										trn.Commit();
									}
									catch(Exception ex)
