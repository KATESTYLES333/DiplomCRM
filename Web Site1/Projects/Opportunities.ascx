...
<SplendidCRM:ListHeader SubPanel="divProjectsOpportunities" Title="Opportunities.LBL_MODULE_NAME" Runat="Server" />

<div id="divProjectsOpportunities" style='<%= "display:" + (CookieValue("divProjectsOpportunities") != "1" ? "inline" : "none") %>'>
