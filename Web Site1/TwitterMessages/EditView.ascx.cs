			...
			try
			{
				...
				if ( !IsPostBack )
				{
					...
					if ( Sql.IsEmptyGuid(gID) )
					{
						...
						ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("TwitterMessages.LBL_NEW_FORM_TITLE") + "</a><span class=\"pointer\">&raquo;</span>";
								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											{
												case "out":
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("TwitterMessages.LBL_LIST_FORM_SENT_TITLE") + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
												default:
													sTWITTER_TYPE = "draft";
													ctlModuleHeader.Title = "<a href=\"default.aspx\">" + L10n.Term("TwitterMessages.LBL_NEW_FORM_TITLE" ) + "</a><span class=\"pointer\">&raquo;</span>" + txtNAME.Text;
													break;
											}
											ctlModuleHeader.EnableModuleLabel = false;
