<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Cases.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divCasesActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divCasesActivityStream" style='<%= "display:" + (CookieValue("divCasesActivityStream") != "1" ? "inline" : "none") %>'>
