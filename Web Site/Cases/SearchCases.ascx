...
<SplendidCRM:SubPanelButtons Module="Cases" SubPanel="divSearchCases" ID="ctlListHeader" Title="Cases.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchCases" style='<%= "display:" + (CookieValue("divSearchCases") != "1" ? "inline" : "none") %>'>
