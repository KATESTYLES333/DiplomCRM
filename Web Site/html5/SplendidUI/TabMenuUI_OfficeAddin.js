...
function TabMenuUI_OfficeAddin(sLayoutPanel, sActionsPanel)
{
...
TabMenuUI_OfficeAddin.prototype.divError           = function() { return this.divHeader_divError          ; }
TabMenuUI_OfficeAddin.prototype.divAuthenticated   = function() { return this.divHeader_divAuthenticated  ; }
TabMenuUI_OfficeAddin.prototype.spnWelcome         = function() { return this.divHeader_spnWelcome        ; }
TabMenuUI_OfficeAddin.prototype.spnUserName        = function() { return this.divHeader_spnUserName       ; }
TabMenuUI_OfficeAddin.prototype.spnLogout          = function() { return this.divHeader_spnLogout         ; }
TabMenuUI_OfficeAddin.prototype.lnkLogout          = function() { return this.divHeader_lnkLogout         ; }
// 08/22/2014 Paul.  Add SyncNow for offline client. 
TabMenuUI_OfficeAddin.prototype.spnSyncNow         = function() { return this.divHeader_spnSyncNow        ; }
TabMenuUI_OfficeAddin.prototype.lnkSyncNow         = function() { return this.divHeader_lnkSyncNow        ; }
TabMenuUI_OfficeAddin.prototype.divOnlineStatus    = function() { return this.divHeader_divOnlineStatus   ; }
TabMenuUI_OfficeAddin.prototype.divOfflineCache    = function() { return this.divHeader_divOfflineCache   ; }
TabMenuUI_OfficeAddin.prototype.divSplendidStorage = function() { return this.divHeader_divSplendidStorage; }
TabMenuUI_OfficeAddin.prototype.lnkCacheAll        = function() { return this.lnkHeaderCacheAll           ; }
TabMenuUI_OfficeAddin.prototype.lnkSystemLog       = function() { return this.lnkHeaderSystemLog          ; }
TabMenuUI_OfficeAddin.prototype.lnkSplendidStorage = function() { return this.lnkHeaderSplendidStorage    ; }

TabMenuUI_OfficeAddin.prototype.RenderHeader = function()
{
	try
	{
	...
	{
		SplendidError.SystemAlert(e, 'TabMenuUI_OfficeAddin.RenderHeader');
	}
}

// 12/06/2014 Paul.  LayoutMode is used on the Mobile view. 
TabMenuUI_OfficeAddin.prototype.ActivateTab = function(sMODULE_NAME, sID, sLAYOUT_MODE, obj)
{
...
TabMenuUI_OfficeAddin.prototype.Render = function(sLayoutPanel, sActionsPanel, arrDetailViewRelationship, arrQuickCreate, result)
{
	this.LayoutPanel  = sLayoutPanel ;
	this.ActionsPanel = sActionsPanel;
	...
	if ( ctlAtlanticToolbar != null )
	{
		...
		aNavBack.onclick = BindArguments(function(sLayoutPanel, sActionsPanel)
		{
		...
		//}
		var item = new Object();
		item.name  = L10n.ListTerm('moduleList', 'Home');
		item.title = item.name;
...
TabMenuUI_OfficeAddin.prototype.Load = function(sLayoutPanel, sActionsPanel, sMODULE_NAME, callback)
{
	try
	{
					...
					if ( status == 0 || status == 1 )
					{
						...
						bgPage.TabMenu_Load(function(status, message)
						{
							if ( status == 0 || status == 1 )
							{
								...
								{
									callback(-1, SplendidError.FormatError(e, 'TabMenuUI_OfficeAddin.Load'));
								}
							}
							else
							{
