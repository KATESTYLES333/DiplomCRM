...
define(function()
{
	var sMODULE_NAME    = 'Project';
	var sGRID_NAME      = sMODULE_NAME + '.My' + sMODULE_NAME + 's';
	var sTABLE_NAME     = 'vw' + (sMODULE_NAME + 's').toUpperCase() + '_MyList';
	var sSORT_FIELD     = 'ESTIMATED_END_DATE';
