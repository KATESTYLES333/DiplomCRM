<%@ Control CodeBehind="SearchAccounts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.SearchAccounts" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Accounts" SubPanel="divSearchAccounts" ID="ctlListHeader" Title="Accounts.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchAccounts" style='<%= "display:" + (CookieValue("divSearchAccounts") != "1" ? "inline" : "none") %>'>
