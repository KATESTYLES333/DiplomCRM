...
function LeadPopup()
{
	return ModulePopup('Leads', '<%= txtLEAD_ID.ClientID %>', null, 'ClearDisabled=1&EditableOnly=1', true, 'PopupMultiSelect.aspx');
}
</script>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Leads" SubPanel="divAccountsLeads" Title="Leads.LBL_MODULE_NAME" Runat="Server" />
