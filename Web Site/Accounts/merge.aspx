<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="merge.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.Merge" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:MergeView ID="ctlMergeView" Module="Accounts" Visible='<%# SplendidCRM.Security.GetUserAccess("Accounts", "edit") >= 0 %>' Runat="Server" />
