<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divAccountsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divAccountsActivitiesOpen" style='<%= "display:" + (CookieValue("divAccountsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divAccountsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divAccountsActivitiesHistory" style='<%= "display:" + (CookieValue("divAccountsActivitiesHistory") != "1" ? "inline" : "none") %>'>
