<%@ Control CodeBehind="Cases.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.Cases" %>
<script runat="server">
/**********************************************************************************************************************
...
function CasePopup()
{
	return ModulePopup('Cases', '<%= txtCASE_ID.ClientID %>', null, 'ClearDisabled=1&ACCOUNT_ID=<%= gID %>', true, null);
}
</script>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Cases" SubPanel="divAccountsCases" Title="Cases.LBL_MODULE_NAME" Runat="Server" />

<div id="divAccountsCases" style='<%= "display:" + (CookieValue("divAccountsCases") != "1" ? "inline" : "none") %>'>
