<%@ Control CodeBehind="SearchPhones.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.SearchPhones" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Accounts" SubPanel="divAccountsSearchPhones" ID="ctlListHeader" Title="Accounts.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divAccountsSearchPhones" style='<%= "display:" + (CookieValue("divAccountsSearchPhones") != "1" ? "inline" : "none") %>'>
