<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.Import" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:ImportView ID="ctlImportView" Module="Accounts" Visible='<%# SplendidCRM.Security.GetUserAccess("Accounts", "import") >= 0 %>' Runat="Server" />
