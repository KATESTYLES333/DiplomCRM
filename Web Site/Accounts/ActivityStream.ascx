<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divAccountsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divAccountsActivityStream" style='<%= "display:" + (CookieValue("divAccountsActivityStream") != "1" ? "inline" : "none") %>'>
