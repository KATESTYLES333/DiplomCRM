<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	<SplendidCRM:SearchView ID="ctlSearchView" Module="Accounts" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeAccount != null )
		{
			...
			window.opener.ChangeAccount(sSelectedItems, '');
			window.close();
		}
		else
		{
