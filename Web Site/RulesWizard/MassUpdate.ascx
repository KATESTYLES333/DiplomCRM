<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.RulesWizard.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divRulesWizardMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divRulesWizardMassUpdate" style='<%= "display:" + (CookieValue("divRulesWizardMassUpdate") != "1" ? "inline" : "none") %>'>
