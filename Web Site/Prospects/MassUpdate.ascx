<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.Prospects.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divProspectsMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divProspectsMassUpdate" style='<%= "display:" + (CookieValue("divProspectsMassUpdate") != "1" ? "inline" : "none") %>'>
