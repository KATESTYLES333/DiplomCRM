<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Prospects.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divProspectsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divProspectsActivitiesOpen" style='<%= "display:" + (CookieValue("divProspectsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divProspectsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divProspectsActivitiesHistory" style='<%= "display:" + (CookieValue("divProspectsActivitiesHistory") != "1" ? "inline" : "none") %>'>
