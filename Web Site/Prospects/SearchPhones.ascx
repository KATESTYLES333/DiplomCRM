<%@ Control CodeBehind="SearchPhones.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Prospects.SearchPhones" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Prospects" SubPanel="divProspectsSearchPhones" ID="ctlListHeader" Title="Prospects.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divProspectsSearchPhones" style='<%= "display:" + (CookieValue("divProspectsSearchPhones") != "1" ? "inline" : "none") %>'>
