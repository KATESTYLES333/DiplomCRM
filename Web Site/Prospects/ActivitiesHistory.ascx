...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divProspectsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Visible="false" Runat="Server" />

<div id="divProspectsActivitiesOpen" visible="false" runat="server">
