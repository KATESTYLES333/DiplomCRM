<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Prospects.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divProspectsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divProspectsActivityStream" style='<%= "display:" + (CookieValue("divProspectsActivityStream") != "1" ? "inline" : "none") %>'>
