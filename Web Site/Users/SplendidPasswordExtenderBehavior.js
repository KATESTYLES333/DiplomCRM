	...
	function execute()
	{
		...
		Sys.Extended.UI.SplendidPasswordExtenderBehavior.prototype =
		{
			initialize : function()
			{
				...
				{
					// 03/05/2011 Paul.  We are going to allow a zero length password. 
				...
				// 03/05/2011 Paul.  Lets save the help text on initialize and restore it.  This will allow us to use the lblError field as the postback error field. 
				...
				// 03/05/2011 Paul.  The get password function will update the help text, so just restore the previous value after the call. 
			...
			_getSplendidPassword : function()
			{
				...
				// 02/19/2011 Paul.  Trim leading and trailing spaces. 
