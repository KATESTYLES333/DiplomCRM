<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Users.UserSignatures.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDetailView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Module="UserSignatures" EnablePrint="false" HelpName="DetailView" EnableHelp="true" EnableFavorites="true" Runat="Server" />
