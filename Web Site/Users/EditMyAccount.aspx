<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="EditMyAccount.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Users.EditMyAccount" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:EditView ID="ctlEditView" MyAccount="true" Runat="Server" />
