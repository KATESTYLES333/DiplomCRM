<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Resources.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divResourcesActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divResourcesActivitiesOpen" style='<%= "display:" + (CookieValue("divResourcesActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divResourcesActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divResourcesActivitiesHistory" style='<%= "display:" + (CookieValue("divResourcesActivitiesHistory") != "1" ? "inline" : "none") %>'>
