<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditView.ascx.cs" Inherits="SplendidCRM.Resources.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="Resources" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
		...
		<asp:TableRow>
			<asp:TableCell>
				<table ID="tblMain" class="tabEditView" runat="server">
					<tr>
						<th colspan="4"><h4><asp:Label Text='<%# L10n.Term("Resources.LBL_RESOURCE_INFORMATION") %>' runat="server" /></h4></th>
					</tr>
				</table>
			</asp:TableCell>
		</asp:TableRow>
	...
	<asp:Button ID="partner_UPDATE" Text="partner_UPDATE" style="display: none" runat="server" />
		...
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table ID="tblPortal" class="tabEditView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell ColumnSpan="4"><h4><asp:Label Text='<%# L10n.Term("Resources.LBL_PORTAL_INFORMATION") %>' runat="server" /></h4></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel" VerticalAlign="top"><asp:Label Text='<%# L10n.Term("Resources.LBL_PORTAL_NAME") %>' runat="server" /></asp:TableCell>
						...
						<asp:TableCell CssClass="dataLabel" VerticalAlign="top"><asp:Label Text='<%# L10n.Term("Resources.LBL_PORTAL_ACTIVE") %>' runat="server" /></asp:TableCell>
					...
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel" VerticalAlign="top"><asp:Label Text='<%# L10n.Term("Resources.LBL_PORTAL_PASSWORD") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField" VerticalAlign="top">
						...
						<asp:TableCell CssClass="dataLabel" VerticalAlign="top"><asp:Label Text='<%# L10n.Term("Resources.LBL_CONFIRM_PORTAL_PASSWORD") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField" VerticalAlign="top">
...
<SplendidCRM:DumpSQL ID="ctlDumpSQL" Visible="false" Runat="Server" />
