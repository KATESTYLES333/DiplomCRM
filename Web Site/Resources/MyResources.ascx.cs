...
namespace SplendidCRM.Resources
{
	...
	/// </summary>
	public class MyResources : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				m_sVIEW_NAME = "vwRESOURCES_MyList";
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					if ( bDebug )
						RegisterClientScriptBlock("vwRESOURCES_List", Sql.ClientScriptBlock(cmd));
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyResources", dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( this.Visible && !Sql.IsEmptyString(sDetailView) )
			{
				...
				vwFields.RowFilter = "CONTROL_NAME = '~/Resources/MyResources'";
		...
		private void InitializeComponent()
		{
			...
			// 08/13/2008 John.  Fix problem with arrSelectFields. 
			this.AppendGridColumns(grdMain, "Resources.MyResources", arrSelectFields);
		}
		#endregion
	}
}
