<%@ Control CodeBehind="Requests.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Resources.Notes" %>
<script runat="server">
/**********************************************************************************************************************
...
{
	return ModulePopup('Notes', '<%= txtNOTE_ID.ClientID %>', null, 'ClearDisabled=1', true, null);
}
</script>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Notes" SubPanel="divResourcesRequests" Title="Notes.LBL_MODULE_NAME" Runat="Server" />
