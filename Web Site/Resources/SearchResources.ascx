<%@ Control CodeBehind="SearchResources.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Resources.SearchResources" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Resources" SubPanel="divSearchResources" ID="ctlListHeader" Title="Resources.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchResources" style='<%= "display:" + (CookieValue("divSearchResources") != "1" ? "inline" : "none") %>'>
