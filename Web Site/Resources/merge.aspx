<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="merge.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Resources.Merge" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:MergeView ID="ctlMergeView" Module="Resources" Visible='<%# SplendidCRM.Security.GetUserAccess("Resources", "edit") >= 0 %>' Runat="Server" />
