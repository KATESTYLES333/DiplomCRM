<%@ Page language="c#" MasterPageFile="~/PopupView.Master" Codebehind="PopupAddress.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.ZipCodes.PopupAddress" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="PopupView" Src="PopupAddressView.ascx" %>
