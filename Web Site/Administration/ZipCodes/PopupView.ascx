<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Administration.ZipCodes.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	function SelectZipCode(sPARENT_ID, sPARENT_NAME)
	{
		if ( window.opener != null && window.opener.ChangeZipCode != null )
		{
			window.opener.ChangeZipCode(sPARENT_ID, sPARENT_NAME);
			window.close();
		}
		else
		{
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeZipCode != null )
		{
			...
			window.opener.ChangeZipCode(sSelectedItems, '');
			window.close();
		}
		else
		{
