...
<div id="divNetworkView" Visible="false">
	<%@ Register TagPrefix="SplendidCRM" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<SplendidCRM:ListHeader Title="Administration.LBL_SPLENDIDCRM_NETWORK_TITLE" Visible="false" Runat="Server" />
	<asp:Table Visible="false" Width="100%" CssClass="tabDetailView2" runat="server">
		<asp:TableRow>
