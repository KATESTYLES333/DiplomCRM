...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="Dropdown" Title=".moduleList.Home" EnablePrint="true" HelpName="EditView" EnableHelp="true" Runat="Server" />
			...
			<asp:TableCell>
				<asp:Table SkinID="tabEditView" runat="server">
					<asp:TableRow>
						...
						<asp:TableCell Width="35%" CssClass="dataField"><asp:TextBox ID="txtNAME" TabIndex="1" size="35" MaxLength="50" Runat="server" /></asp:TableCell>
