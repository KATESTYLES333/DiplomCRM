					...
					if ( !Sql.IsEmptyGuid(gID) )
					{
						...
						using ( IDbConnection con = dbf.CreateConnection() )
						{
							...
							sSQL = "select *             " + ControlChars.CrLf
							     + "     , (select count(*) from vwMODULES_ARCHIVE_RELATED where vwMODULES_ARCHIVE_RELATED.MODULE_NAME = vwMODULES_Edit.MODULE_NAME) as ARCHIVE_AVAILABLE" + ControlChars.CrLf
