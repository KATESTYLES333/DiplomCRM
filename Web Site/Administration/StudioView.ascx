...
<div id="divStudioView" visible="false" runat="server">
...
$(document).ready(function()
{
	...
	<asp:Table Width="100%" CssClass="tabDetailView2" runat="server">
		...
		<asp:TableRow>
			...
			<asp:TableCell CssClass="tabDetailViewDL2" Visible='<%# SplendidCRM.Security.AdminUserAccess("FullTextSearch", "access") >= 0 %>'>
		...
		<asp:TableRow>
			<asp:TableCell CssClass="tabDetailViewDL2" Visible='<%# SplendidCRM.Security.AdminUserAccess("Tags", "access") >= 0 %>'>
			...
			<asp:TableCell CssClass="tabDetailViewDF2" Visible='<%# SplendidCRM.Security.AdminUserAccess("Tags", "access") >= 0 %>'>
