		...
		protected void Page_Command(object sender, CommandEventArgs e)
		{
			try
			{
				...
				if ( e.CommandName == "Mailbox.CheckMail" || e.CommandName == "Mailbox.CheckBounce" || e.CommandName == "Mailbox.CheckInbound" )
				{
					...
					{
						ExchangeSync.UserSync User = new ExchangeSync.UserSync(Context, String.Empty, String.Empty, String.Empty, String.Empty, gID, String.Empty, false, bOFFICE365_OAUTH_ENABLED);
						string sFOLDER_ID = ExchangeUtils.GetFolderId(Context, String.Empty, String.Empty, gID, sMAILBOX);
