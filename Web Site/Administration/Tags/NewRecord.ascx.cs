...
namespace SplendidCRM.Administration.Tags
{
	...
	public class NewRecord : NewRecordControl
	{
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			SqlProcs.spTAGS_Update
				( ref gID
				, new DynamicControl(this, "NAME"       ).Text
				, gASSIGNED_USER_ID
				, new DynamicControl(this, "SOURCE_ID"  ).ID
				, new DynamicControl(this, "SOURCE_TYPE").Text
				, new DynamicControl(this, "SOURCE_META").Text
				...
				if ( e.CommandName == "NewRecord" )
				{
					...
					if ( Page.IsValid )
					{
						...
						if ( !Sql.IsEmptyString(RulesRedirectURL) )
							...
							Response.Redirect("~/Administration/" + m_sMODULE + "/view.aspx?ID=" + gID.ToString());
					}
				}
				else if ( Command != null )
				{
