<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.EditCustomFields.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<SplendidCRM:Shortcuts ID="ctlShortcuts" SubMenu="EditCustomFields" Runat="Server" />
</asp:Content>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<br />
	<%@ Register TagPrefix="SplendidCRM" Tagname="NewRecord" Src="~/Administration/EditCustomFields/NewRecord.ascx" %>
	<SplendidCRM:NewRecord ID="ctlNewRecord" Visible='<%# ctlListView.Visible %>' Runat="Server" />
</asp:Content>
