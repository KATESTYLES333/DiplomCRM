<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Administration.NAICSCodes.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	<SplendidCRM:SearchView ID="ctlSearchView" Module="NAICSCodes" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />

	<script type="text/javascript">
	function SelectNAICSCode(sPARENT_ID, sPARENT_NAME)
	{
		if ( window.opener != null && window.opener.ChangeTeam != null )
		{
			window.opener.ChangeNAICSCode(sPARENT_ID, sPARENT_NAME);
			window.close();
		}
		else
		{
	...
	function SelectChecked()
	{
		if ( window.opener != null && window.opener.ChangeTeam != null )
		{
			...
			window.opener.ChangeNAICSCode(sSelectedItems, '');
			window.close();
		}
		else
		{
