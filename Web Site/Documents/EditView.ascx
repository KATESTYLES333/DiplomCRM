...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Visible="<%# !SplendidDynamic.StackedLayout(this.Page.Theme) && !PrintView %>" ShowRequired="true" EditView="true" Module="Documents" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
	...
	<SplendidCRM:DynamicButtons ID="ctlFooterButtons" Visible="false" ShowRequired="false" Runat="Server" />
</div>
