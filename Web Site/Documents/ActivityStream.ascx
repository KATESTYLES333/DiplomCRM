<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Documents.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Visible="false" ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divDocumentsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divDocumentsActivityStream" style='<%= "display:" + (CookieValue("divDocumentsActivityStream") != "1" ? "inline" : "none") %>'>
