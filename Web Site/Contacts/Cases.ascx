<%@ Control CodeBehind="Cases.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.Cases" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Cases" SubPanel="divContactsCases" Title="Cases.LBL_MODULE_NAME" Runat="Server" />

<div id="divContactsCases" style='<%= "display:" + (CookieValue("divContactsCases") != "1" ? "inline" : "none") %>'>
