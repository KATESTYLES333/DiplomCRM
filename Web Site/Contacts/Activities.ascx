<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divContactsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divContactsActivitiesOpen" style='<%= "display:" + (CookieValue("divContactsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divContactsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divContactsActivitiesHistory" style='<%= "display:" + (CookieValue("divContactsActivitiesHistory") != "1" ? "inline" : "none") %>'>
