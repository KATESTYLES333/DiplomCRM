<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divContactsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divContactsActivityStream" style='<%= "display:" + (CookieValue("divContactsActivityStream") != "1" ? "inline" : "none") %>'>
