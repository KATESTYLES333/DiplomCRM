<%@ Control CodeBehind="SearchPhones.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.SearchPhones" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Contacts" SubPanel="divContactsSearchPhones" ID="ctlListHeader" Title="Contacts.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divContactsSearchPhones" style='<%= "display:" + (CookieValue("divContactsSearchPhones") != "1" ? "inline" : "none") %>'>
