...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="Emails" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
				...
				<asp:Table SkinID="tabEditView" runat="server">
					...
					<asp:TableRow>
						...
						<asp:TableCell CssClass="dataField" ColumnSpan="3">
							...
							<asp:Button ID="btnChangeCC"  UseSubmitBehavior="false" OnClientClick=<%# "sChangeContactEmailADDRS='" + txtCC_ADDRS.ClientID  + "'; sChangeContactEmailADDRS_IDS='" + txtCC_ADDRS_IDS.ClientID  + "'; sChangeContactEmailADDRS_NAMES='" + txtCC_ADDRS_NAMES.ClientID  + "'; sChangeContactEmailADDRS_EMAILS='" + txtCC_ADDRS_EMAILS.ClientID  + "'; window.open('PopupEmailAddresses.aspx', 'EmailAddressesPopup', '" + SplendidCRM.Crm.Config.PopupWindowOptions() + "'); return false;" %> Text='<%# L10n.Term(".LBL_SELECT_BUTTON_LABEL") %>' ToolTip='<%# L10n.Term(".LBL_SELECT_BUTTON_TITLE") %>' CssClass="button" runat="server" />
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						...
						<asp:TableCell CssClass="dataField" ColumnSpan="3">
							...
							<asp:Button ID="btnChangeBCC" UseSubmitBehavior="false" OnClientClick=<%# "sChangeContactEmailADDRS='" + txtBCC_ADDRS.ClientID + "'; sChangeContactEmailADDRS_IDS='" + txtBCC_ADDRS_IDS.ClientID + "'; sChangeContactEmailADDRS_NAMES='" + txtBCC_ADDRS_NAMES.ClientID + "'; sChangeContactEmailADDRS_EMAILS='" + txtBCC_ADDRS_EMAILS.ClientID + "'; window.open('PopupEmailAddresses.aspx', 'EmailAddressesPopup', '" + SplendidCRM.Crm.Config.PopupWindowOptions() + "'); return false;" %> Text='<%# L10n.Term(".LBL_SELECT_BUTTON_LABEL") %>' ToolTip='<%# L10n.Term(".LBL_SELECT_BUTTON_TITLE") %>' CssClass="button" runat="server" />
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						...
						<asp:TableCell CssClass="dataField" VerticalAlign="Top" ColumnSpan="3">
							<asp:Repeater id="ctlTemplateAttachments" runat="server">
								...
								<ItemTemplate>
									...
									&nbsp;<asp:ImageButton OnCommand="Page_Command" CommandName="TemplateAttachments.Delete" CommandArgument='<%# Eval("NOTE_ATTACHMENT_ID") %>' ImageUrl='<%# Session["themeURL"] + "images/delete_inline.gif"  %>' ImageAlign="Middle" runat="server" /><br />
								</ItemTemplate>
								<FooterTemplate />
							</asp:Repeater>
							<asp:Repeater id="ctlKBAttachments" runat="server">
								...
								<ItemTemplate>
									...
									&nbsp;<asp:ImageButton OnCommand="Page_Command" CommandName="KBDocuments.Delete" CommandArgument='<%# Eval("ID") %>' ImageUrl='<%# Session["themeURL"] + "images/delete_inline.gif"  %>' ImageAlign="Middle" runat="server" /><br />
								</ItemTemplate>
								<FooterTemplate />
							</asp:Repeater>
