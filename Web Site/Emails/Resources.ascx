<%@ Control CodeBehind="Resources.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Emails.Resources" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Resources" SubPanel="divEmailsResources" Title="Resources.LBL_MODULE_NAME" Runat="Server" />

<div id="divEmailsResources" style='<%= "display:" + (CookieValue("divEmailsResources") != "1" ? "inline" : "none") %>'>
