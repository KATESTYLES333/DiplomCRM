<%@ Control CodeBehind="Partners.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Emails.Partners" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Partners" SubPanel="divEmailsPartners" Title="Partners.LBL_MODULE_NAME" Runat="Server" />

<div id="divEmailsPartners" style='<%= "display:" + (CookieValue("divEmailsPartners") != "1" ? "inline" : "none") %>'>
