<%@ Control CodeBehind="Resources.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Meetings.Resources" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Resources" SubPanel="divLeadsResources" Title="Resources.LBL_MODULE_NAME" Runat="Server" />

<div id="divLeadsResources" style='<%= "display:" + (CookieValue("divLeadsResources") != "1" ? "inline" : "none") %>'>
