...
namespace SplendidCRM
{
	...
	public class SplendidControl : System.Web.UI.UserControl
	{
		...
		public bool DisableFavorites()
		{
			...
			{
				this.m_bDisableFavorites = Sql.ToBoolean(Sql.ToBoolean(Application["CONFIG.disable_favorites"]));
			}
		...
		public bool DisableFollowing()
		{
			...
			{
				this.m_bDisableFollowing = Sql.ToBoolean(Sql.ToBoolean(Application["CONFIG.disable_Following"]));
			}
