...
namespace SplendidCRM
{
	...
	public class ActiveDirectory
	{
		...
		public static Office365AccessToken Office365AcquireAccessToken(HttpContext Context, string sOAuthClientID, string sOAuthClientSecret, Guid gUSER_ID, string sAuthorizationCode)
		{
