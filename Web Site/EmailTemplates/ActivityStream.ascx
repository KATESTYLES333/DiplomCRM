<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.EmailTemplates.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divEmailTemplatesActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divEmailTemplatesActivityStream" style='<%= "display:" + (CookieValue("divEmailTemplatesActivityStream") != "1" ? "inline" : "none") %>'>
