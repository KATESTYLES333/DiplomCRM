<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.ProjectTasks.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divProjectTasksActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divProjectTasksActivitiesOpen" style='<%= "display:" + (CookieValue("divProjectTasksActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divProjectTasksActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divProjectTasksActivitiesHistory" style='<%= "display:" + (CookieValue("divProjectTasksActivitiesHistory") != "1" ? "inline" : "none") %>'>
