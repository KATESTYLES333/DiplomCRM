<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.ProjectTasks.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divProjectTasksMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divProjectTasksMassUpdate" style='<%= "display:" + (CookieValue("divProjectTasksMassUpdate") != "1" ? "inline" : "none") %>'>
		...
		<asp:TableRow>
			<asp:TableCell>
				...
				<asp:Table Width="100%" CellPadding="0" CellSpacing="0" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Tasks.LBL_PRIORITY") %>' runat="server" /></asp:TableCell>
						...
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Tasks.LBL_STATUS") %>' runat="server" /></asp:TableCell>
					...
					<asp:TableRow>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Tasks.LBL_DUE_DATE") %>' runat="server" /></asp:TableCell>
						<asp:TableCell Width="35%" CssClass="dataField"><SplendidCRM:DatePicker ID="ctlDATE_DUE" Runat="Server" /></asp:TableCell>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Tasks.LBL_START_DATE") %>' runat="server" /></asp:TableCell>
