<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.ProspectLists.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divProspectListsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divProspectListsActivityStream" style='<%= "display:" + (CookieValue("divProspectListsActivityStream") != "1" ? "inline" : "none") %>'>
