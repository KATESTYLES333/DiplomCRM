...
{
	/// <summary>
	/// Summary description for UnifiedSearch.
	/// </summary>
	public class UnifiedSearch : SplendidPage
	{
		protected string        m_sMODULE      ;
		// 08/31/2010 Paul.  Don't use lblError as it will stop the Precompile. 
		...
		{    
			...
			this.AppendDetailViewRelationships(m_sMODULE + ".UnifiedSearch", plcSubPanel);
		}
		#endregion
	}
}
