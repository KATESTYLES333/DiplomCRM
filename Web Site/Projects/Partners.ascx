<%@ Control CodeBehind="Partners.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Projects.Partners" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Partners" SubPanel="divProjectsPartners" Title="Partners.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divProjectsPartners" style='<%= "display:" + (CookieValue("divProjectsPartners") != "1" ? "inline" : "none") %>'>
		...
		<Columns>
			<asp:TemplateColumn  HeaderText="" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
				<ItemTemplate>
					...
					&nbsp;
					<span onclick="return confirm('<%= L10n.TermJavaScript("Partners.partner_REMOVE_PROJECT_CONFIRM") %>')">
