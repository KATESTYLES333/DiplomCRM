...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divProjectsActivitiesOpen" Title="ProjectTask.LBL_ACTIVITIES_SUBPANEL_TITLE" Runat="Server" />

<div id="divProjectsActivitiesOpen" style='<%= "display:" + (CookieValue("divProjectsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divProjectsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divProjectsActivitiesHistory" style='<%= "display:" + (CookieValue("divProjectsActivitiesHistory") != "1" ? "inline" : "none") %>'>
