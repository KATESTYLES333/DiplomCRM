...
<SplendidCRM:SubPanelButtons Module="Project" SubPanel="divSearchProjects" ID="ctlListHeader" Title="Project.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchProjects" style='<%= "display:" + (CookieValue("divSearchProjects") != "1" ? "inline" : "none") %>'>
