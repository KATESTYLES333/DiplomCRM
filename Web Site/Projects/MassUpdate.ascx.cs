		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				if ( !IsPostBack )
				{
					...
					lstSTATUS  .DataSource = SplendidCache.List("project_status_dom");
					lstSTATUS  .DataBind();
					lstSTATUS  .Items.Insert(0, new ListItem(L10n.Term(".LBL_NONE"), ""));
					lstPRIORITY.DataSource = SplendidCache.List("projects_priority_options");
