...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Accounts" SubPanel="divProjectsAccounts" Title="Accounts.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divProjectsAccounts" style='<%= "display:" + (CookieValue("divProjectsAccounts") != "1" ? "inline" : "none") %>'>
