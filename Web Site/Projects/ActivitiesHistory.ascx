...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divProjectsActivitiesOpen" Title="ProjectTask.LBL_ACTIVITIES_SUBPANEL_TITLE" Visible="false" Runat="Server" />

<div id="divProjectsActivitiesOpen" visible="false" runat="server">
