	...
	public class NewRecord : NewRecordControl
	{
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			SqlProcs.spPROJECTS_Update
				...
				, new DynamicControl(this, "ESTIMATED_START_DATE").DateValue
				, new DynamicControl(this, "ESTIMATED_END_DATE"  ).DateValue
				, new DynamicControl(this, "STATUS"              ).Text
				, new DynamicControl(this, "PRIORITY"            ).Text
					...
					if ( Page.IsValid )
					{
						...
						using ( IDbConnection con = dbf.CreateConnection() )
						{
							...
							using ( IDbTransaction trn = Sql.BeginTransaction(con) )
							{
								try
								{
									// 05/16/2010 Paul.  Set the parent values. 
						...
						// 04/26/2010 Paul.  We cannot use the m_sMODULE here because the folder is plural. 
							...
							Response.Redirect("~/Projects/view.aspx?ID=" + gID.ToString());
					}
				}
				else if ( Command != null )
				{
