<%@ Control CodeBehind="SearchPhones.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Partners.SearchPhones" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Partners" SubPanel="divPartnersSearchPhones" ID="ctlListHeader" Title="Partners.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divPartnersSearchPhones" style='<%= "display:" + (CookieValue("divPartnersSearchPhones") != "1" ? "inline" : "none") %>'>
