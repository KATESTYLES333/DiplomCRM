...
namespace SplendidCRM.Partners
{
	...
	public class NewRecord : NewRecordControl
	{
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			Guid gPARTNER_PARENT_ID = new DynamicControl(this, "PARENT_ID"       ).ID;
			...
			SqlProcs.spPARTNERS_InsRelated(gID, sPARENT_TYPE, gPARENT_ID, trn);
		}
