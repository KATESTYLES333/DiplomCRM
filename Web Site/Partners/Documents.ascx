<%@ Control CodeBehind="Documents.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Partners.Documents" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Documents" SubPanel="divPartnersDocuments" Title="Documents.LBL_MODULE_NAME" Runat="Server" />

<div id="divPartnersDocuments" style='<%= "display:" + (CookieValue("divPartnersDocuments") != "1" ? "inline" : "none") %>'>
