<%@ Control CodeBehind="SearchPartners.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Partners.SearchPartners" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Partners" SubPanel="divSearchPartners" ID="ctlListHeader" Title="Partners.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchPartners" style='<%= "display:" + (CookieValue("divSearchPartners") != "1" ? "inline" : "none") %>'>
