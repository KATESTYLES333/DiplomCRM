...
{
	/// <summary>
	///		Summary description for MyPartners.
	/// </summary>
	public class MyPartners : DashletControl
	{
		...
		protected void Bind(bool bBind)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				m_sVIEW_NAME = "vwPartners_MyList";
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					if ( bDebug )
						RegisterClientScriptBlock("vwPartners_List", Sql.ClientScriptBlock(cmd));
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							using ( DataTable dt = new DataTable() )
							{
								...
								this.ApplyGridViewRules(m_sMODULE + ".MyPartners", dt);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( this.Visible && !Sql.IsEmptyString(sDetailView) )
			{
				...
				vwFields.RowFilter = "CONTROL_NAME = '~/Partners/MyPartners'";
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Partners.MyPartners", arrSelectFields);
		}
		#endregion
	}
}
