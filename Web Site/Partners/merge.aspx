<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="merge.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Partners.Merge" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:MergeView ID="ctlMergeView" Module="Partners" Visible='<%# SplendidCRM.Security.GetUserAccess("Partners", "edit") >= 0 %>' Runat="Server" />
