<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Partners.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
...
function CopyBillingToResource()
{
	var txtADDRESS_TYPE = document.getElementById('<%= txtADDRESS_TYPE.ClientID %>');
	txtADDRESS_TYPE.value = "Billing";
	return ModulePopup('Resources', '<%= txtRESOURCE_ID.ClientID %>', null, 'ClearDisabled=1&FilterPartner=1&PARTNER_ID=<%= gID %>', true, 'PopupMultiSelect.aspx');
	return false;
}
function CopyShippingToResource()
{
	var txtADDRESS_TYPE = document.getElementById('<%= txtADDRESS_TYPE.ClientID %>');
...
<div id="divDetailView" runat="server">
	...
	<asp:HiddenField ID="txtRESOURCE_ID"     Runat="server" />

	<%-- 05/31/2015 Paul.  Combine ModuleHeader and DynamicButtons. --%>
	<%@ Register TagPrefix="SplendidCRM" Tagname="HeaderButtons" Src="~/_controls/HeaderButtons.ascx" %>
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Module="Partners" EnablePrint="false" HelpName="DetailView" EnableHelp="true" EnableFavorites="true" Runat="Server" />
