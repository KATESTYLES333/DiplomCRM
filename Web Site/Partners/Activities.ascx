<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Partners.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divPartnersActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divPartnersActivitiesOpen" style='<%= "display:" + (CookieValue("divPartnersActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divPartnersActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divPartnersActivitiesHistory" style='<%= "display:" + (CookieValue("divPartnersActivitiesHistory") != "1" ? "inline" : "none") %>'>
