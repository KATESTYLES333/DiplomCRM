<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Partners.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divPartnersActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divPartnersActivityStream" style='<%= "display:" + (CookieValue("divPartnersActivityStream") != "1" ? "inline" : "none") %>'>
