<%@ Control CodeBehind="SearchBugs.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.SearchBugs" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Bugs" SubPanel="divSearchBugs" ID="ctlListHeader" Title="Bugs.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchBugs" style='<%= "display:" + (CookieValue("divSearchBugs") != "1" ? "inline" : "none") %>'>
