<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divBugsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divBugsActivitiesOpen" style='<%= "display:" + (CookieValue("divBugsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divBugsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divBugsActivitiesHistory" style='<%= "display:" + (CookieValue("divBugsActivitiesHistory") != "1" ? "inline" : "none") %>'>
