<%@ Control CodeBehind="Accounts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.Accounts" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Accounts" SubPanel="divBugsAccounts" Title="Accounts.LBL_LIST_FORM_TITLE" Runat="Server" />
