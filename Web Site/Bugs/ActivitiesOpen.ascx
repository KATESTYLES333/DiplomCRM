...
<%-- 06/03/2015 Paul.  Combine ListHeader and DynamicButtons. --%>
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divBugsActivitiesHistory" Title="Activities.LBL_HISTORY" Visible="false" Runat="Server" />

<div id="divBugsActivitiesHistory" visible="false" runat="server">
