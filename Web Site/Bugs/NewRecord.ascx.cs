	...
	public class NewRecord : NewRecordControl
	{
		...
		public override void Save(Guid gPARENT_ID, string sPARENT_TYPE, IDbTransaction trn)
		{
			...
			SqlProcs.spBUGS_Update
				...
				, new DynamicControl(this, "FOUND_IN_RELEASE_ID").SelectedValue
				, new DynamicControl(this, "TYPE"               ).SelectedValue
				, new DynamicControl(this, "FIXED_IN_RELEASE_ID").SelectedValue
				...
				, sPARENT_TYPE
				, gPARENT_ID
				, new DynamicControl(this, "BUG_NUMBER"         ).Text
				, gTEAM_ID
