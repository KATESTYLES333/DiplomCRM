<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divBugsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divBugsActivityStream" style='<%= "display:" + (CookieValue("divBugsActivityStream") != "1" ? "inline" : "none") %>'>
