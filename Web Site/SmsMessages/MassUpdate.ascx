<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.SmsMessages.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divSmsMessagesMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divSmsMessagesMassUpdate" style='<%= "display:" + (CookieValue("divSmsMessagesMassUpdate") != "1" ? "inline" : "none") %>'>
