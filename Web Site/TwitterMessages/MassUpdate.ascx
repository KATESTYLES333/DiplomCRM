<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.TwitterMessages.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divTwitterMessagesMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divTwitterMessagesMassUpdate" style='<%= "display:" + (CookieValue("divTwitterMessagesMassUpdate") != "1" ? "inline" : "none") %>'>
