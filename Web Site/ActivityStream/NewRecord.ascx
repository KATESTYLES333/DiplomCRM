		...
		<asp:Table Width="100%" runat="server">
			<asp:TableRow>
				...
				<asp:TableCell style="vertical-align: top; width: 5%; padding: 8px;">
					<asp:Button ID="btnSubmit" CommandName="NewRecord"        OnCommand="Page_Command" CssClass="EditHeaderOtherButton" Text='<%# L10n.Term(".LBL_SUBMIT_BUTTON_LABEL") %>' ToolTip='<%# L10n.Term(".LBL_SUBMIT_BUTTON_LABEL") %>' Runat="server" /><br />
					<asp:Button ID="btnCancel" CommandName="NewRecord.Cancel" OnCommand="Page_Command" CssClass="EditHeaderOtherButton" Text='<%# L10n.Term(".LBL_CANCEL_BUTTON_LABEL") %>' ToolTip='<%# L10n.Term(".LBL_CANCEL_BUTTON_LABEL") %>' Runat="server" />
				</asp:TableCell>
			</asp:TableRow>
		</asp:Table>
