<%@ Control CodeBehind="SearchChatMessages.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.ChatMessages.SearchChatMessages" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="ChatMessages" SubPanel="divSearchChatMessages" ID="ctlListHeader" Title="ChatMessages.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchChatMessages" style='<%= "display:" + (CookieValue("divSearchChatMessages") != "1" ? "inline" : "none") %>'>
