<%@ Control CodeBehind="SearchOpportunities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Opportunities.SearchOpportunities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Opportunities" SubPanel="divSearchOpportunities" ID="ctlListHeader" Title="Opportunities.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchOpportunities" style='<%= "display:" + (CookieValue("divSearchOpportunities") != "1" ? "inline" : "none") %>'>
