<%@ Control CodeBehind="MyPipelineBySalesStage.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Opportunities.xaml2.MyPipelineBySalesStage" %>
<UserControl 
...
<asp:Repeater DataSource="<%# vwMain %>" runat="server">
	<ItemTemplate>
			...
			<Style x:Key="MyBarDataPointStyle" TargetType="charting:BarDataPoint">
		...
		<charting:Chart Title="<%# HttpUtility.HtmlEncode(sGraphData_Title) %>" Height="360" BorderThickness="0">
			...
			<charting:Chart.Series>
				<splendid:StackedBarSeries ItemsSource="{StaticResource SeriesData}" IndependentValueBinding="{Binding Label}" DependentValueBinding="{Binding Value}" DataPointStyle="{StaticResource MyBarDataPointStyle}" Foreground="#395163" FontFamily="Arial" FontSize="11" IsSelectionEnabled="True" />
			</charting:Chart.Series>
			<charting:Chart.Axes>
