<%@ Control CodeBehind="SearchRequests.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Requests.SearchRequests" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Requests" SubPanel="divSearchRequests" ID="ctlListHeader" Title="Requests.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchRequests" style='<%= "display:" + (CookieValue("divSearchRequests") != "1" ? "inline" : "none") %>'>
