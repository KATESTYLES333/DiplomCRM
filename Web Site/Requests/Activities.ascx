<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Requests.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divRequestsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divRequestsActivitiesOpen" style='<%= "display:" + (CookieValue("divRequestsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divRequestsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divRequestsActivitiesHistory" style='<%= "display:" + (CookieValue("divRequestsActivitiesHistory") != "1" ? "inline" : "none") %>'>
