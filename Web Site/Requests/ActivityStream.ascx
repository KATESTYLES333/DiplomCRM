<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Requests.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divRequestsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divRequestsActivityStream" style='<%= "display:" + (CookieValue("divRequestsActivityStream") != "1" ? "inline" : "none") %>'>
