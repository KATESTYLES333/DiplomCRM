<%@ Control CodeBehind="Opportunities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Campaigns.Opportunities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Opportunities" SubPanel="divCampaignsOpportunities" Title="Campaigns.LBL_OPPORTUNITY_SUBPANEL_TITLE" Runat="Server" />

<div id="divCampaignsOpportunities" style='<%= "display:" + (CookieValue("divCampaignsOpportunities") != "1" ? "inline" : "none") %>'>
