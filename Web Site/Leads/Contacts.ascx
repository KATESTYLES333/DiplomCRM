<%@ Control CodeBehind="Contacts.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.Contacts" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="Contacts" SubPanel="divLeadsContacts" Title="Contacts.LBL_MODULE_NAME" Runat="Server" />

<div id="divLeadsContacts" style='<%= "display:" + (CookieValue("divLeadsContacts") != "1" ? "inline" : "none") %>'>
