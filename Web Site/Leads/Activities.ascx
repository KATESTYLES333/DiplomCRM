<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.Activities" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsOpen" Module="Activities" SubPanel="divLeadsActivitiesOpen" Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />

<div id="divLeadsActivitiesOpen" style='<%= "display:" + (CookieValue("divLeadsActivitiesOpen") != "1" ? "inline" : "none") %>'>
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtonsHistory" Module="Activities" SubPanel="divLeadsActivitiesHistory" Title="Activities.LBL_HISTORY" Runat="Server" />

<div id="divLeadsActivitiesHistory" style='<%= "display:" + (CookieValue("divLeadsActivitiesHistory") != "1" ? "inline" : "none") %>'>
