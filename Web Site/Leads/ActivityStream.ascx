<%@ Control CodeBehind="ActivityStream.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.ActivityStream" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons ID="ctlDynamicButtons" Module="ActivityStream" SubPanel="divLeadsActivityStream" Title=".LBL_ACTIVITY_STREAM" Runat="Server" />

<div id="divLeadsActivityStream" style='<%= "display:" + (CookieValue("divLeadsActivityStream") != "1" ? "inline" : "none") %>'>
