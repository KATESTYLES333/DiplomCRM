<%@ Control CodeBehind="SearchPhones.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.SearchPhones" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Leads" SubPanel="divLeadsSearchPhones" ID="ctlListHeader" Title="Leads.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divLeadsSearchPhones" style='<%= "display:" + (CookieValue("divLeadsSearchPhones") != "1" ? "inline" : "none") %>'>
