<%@ Control CodeBehind="SearchLeads.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Leads.SearchLeads" %>
<script runat="server">
/**********************************************************************************************************************
...
<SplendidCRM:SubPanelButtons Module="Leads" SubPanel="divSearchLeads" ID="ctlListHeader" Title="Leads.LBL_LIST_FORM_TITLE" Runat="Server" />

<div id="divSearchLeads" style='<%= "display:" + (CookieValue("divSearchLeads") != "1" ? "inline" : "none") %>'>
