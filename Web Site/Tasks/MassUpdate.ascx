<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.Tasks.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<SplendidCRM:MassUpdateButtons ID="ctlDynamicButtons" SubPanel="divTasksMassUpdate" Title=".LBL_MASS_UPDATE_TITLE" Runat="Server" />

<div id="divTasksMassUpdate" style='<%= "display:" + (CookieValue("divTasksMassUpdate") != "1" ? "inline" : "none") %>'>
