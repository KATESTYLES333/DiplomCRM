<%@ Page language="c#" MasterPageFile="~/PopupView.Master" ValidateRequest="false" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Help.Edit" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:EditView ID="ctlEditView" Visible='<%# SplendidCRM.Security.GetUserAccess("Help", "edit") >= 0 %>' Runat="Server" />
