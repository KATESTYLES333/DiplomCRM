	...
	<asp:Table width="100%" border="0" cellspacing="2" cellpadding="0" runat="server">
		<asp:TableRow>
			...
			<asp:TableCell Width="50%" HorizontalAlign="Center">
				<asp:HyperLink ID="lnkTOPICS" NavigateUrl="topics.aspx" Visible="false" Text='<%# L10n.Term("Help.LBL_TOPICS") %>' runat="server" />
				&nbsp;
				<asp:HyperLink ID="lnkTEST"   NavigateUrl="~/_devtools/TestHelp.aspx" Text='<%# L10n.Term("Help.LBL_TEST") %>' Visible="false" runat="server" />
			</asp:TableCell>
			<asp:TableCell Width="25%" HorizontalAlign="Right">
				<asp:HyperLink ID="lnkPRINT" NavigateUrl="javascript:window.print();" Visible="false" Text='<%# L10n.Term("Help.LBL_HELP_PRINT") %>' runat="server" />
				
				<asp:HyperLink ID="lnkEMAIL" NavigateUrl="#" Visible="false" Text='<%# L10n.Term("Help.LBL_HELP_EMAIL") %>' runat="server" />
				
				<asp:HyperLink ID="lnkBOOKMARK" NavigateUrl="#" Visible="false" onmousedown="createBookmarkLink()" Text='<%# L10n.Term("Help.LBL_HELP_BOOKMARK") %>' runat="server" />
			</asp:TableCell>
		</asp:TableRow>
	</asp:Table>
