<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.CampaignTrackers.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDetailView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" Module="CampaignTrackers" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
