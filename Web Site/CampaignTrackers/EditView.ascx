...
{
	var fldIS_OPTOUT   = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "IS_OPTOUT"  ).ClientID %>');
	var fldTRACKER_URL = document.getElementById('<%= new SplendidCRM.DynamicControl(this, "TRACKER_URL").ClientID %>');
...
<div id="divEditView" runat="server">
	...
	<SplendidCRM:HeaderButtons ID="ctlDynamicButtons" ShowRequired="true" EditView="true" Module="CampaignTrackers" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
