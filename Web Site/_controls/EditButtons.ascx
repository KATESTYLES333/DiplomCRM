<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditButtons.ascx.cs" Inherits="SplendidCRM._controls.EditButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
