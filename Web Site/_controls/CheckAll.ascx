...
<asp:Panel ID="pnlCheckAll" Visible="<%# !SplendidDynamic.StackedLayout(Page.Theme) %>" style="display: inline-block;" runat="server">
	...
	<asp:LinkButton ID="btnSelectAll" Visible="false" Text='<%# L10n.Term(".LBL_SELECT_ALL") %>' CommandName="SelectAll" OnCommand="Page_Command" CssClass="listViewCheckLink" runat="server" />
