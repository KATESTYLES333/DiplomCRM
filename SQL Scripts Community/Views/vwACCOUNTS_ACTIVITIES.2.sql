...
select CALLS.ID
  ...
  from            ACCOUNTS
       inner join CALLS
              ...
              and CALLS.PARENT_TYPE        = N'Accounts'
              and CALLS.DELETED            = 0
  left outer join TEAMS
...
select EMAILS.ID
  ...
  left outer join EMAILS_ACCOUNTS
               on EMAILS_ACCOUNTS.ACCOUNT_ID = ACCOUNTS.ID
              and EMAILS_ACCOUNTS.EMAIL_ID   = EMAILS.ID
...
select EMAILS.ID
  ...
  from            ACCOUNTS
       inner join EMAILS_ACCOUNTS
              ...
              and EMAILS_ACCOUNTS.DELETED    = 0
       inner join EMAILS
               on EMAILS.ID                = EMAILS_ACCOUNTS.EMAIL_ID
              and EMAILS.DELETED           = 0
  left outer join TEAMS
               on TEAMS.ID                 = EMAILS.TEAM_ID
              and TEAMS.DELETED            = 0
...
select NOTES.ID
     ...
     , ACCOUNTS.ASSIGNED_USER_ID      as ACTIVITY_ASSIGNED_USER_ID
     , N'Note'                        as STATUS
     , N'none'                        as DIRECTION
  ...
  from            ACCOUNTS
       inner join NOTES
               on NOTES.PARENT_ID          = ACCOUNTS.ID
              and NOTES.PARENT_TYPE        = N'Accounts'
              and NOTES.DELETED            = 0
  left outer join TEAMS
...
select SMS_MESSAGES.ID
  ...
  from            ACCOUNTS
       inner join SMS_MESSAGES
               on SMS_MESSAGES.PARENT_ID     = ACCOUNTS.ID
              and SMS_MESSAGES.PARENT_TYPE   = N'Accounts'
...
select TWITTER_MESSAGES.ID
  ...
  from            ACCOUNTS
       inner join TWITTER_MESSAGES
               on TWITTER_MESSAGES.PARENT_ID   = ACCOUNTS.ID
              and TWITTER_MESSAGES.PARENT_TYPE = N'Accounts'
...
select CHAT_MESSAGES.ID
  ...
  from            ACCOUNTS
       inner join CHAT_MESSAGES
               on CHAT_MESSAGES.PARENT_ID      = ACCOUNTS.ID
              and CHAT_MESSAGES.PARENT_TYPE    = N'Accounts'
...
select CHAT_MESSAGES.ID
  ...
  from            ACCOUNTS
       inner join CHAT_CHANNELS
               on CHAT_CHANNELS.PARENT_ID      = ACCOUNTS.ID
