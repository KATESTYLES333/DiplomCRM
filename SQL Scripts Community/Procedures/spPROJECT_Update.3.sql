...
as
  begin
	...
	exec dbo.spPROJECTS_Update @ID out, @MODIFIED_USER_ID, @ASSIGNED_USER_ID, @NAME, @DESCRIPTION, @PARENT_TYPE, @PARENT_ID, @TEAM_ID, @TEAM_SET_LIST, @ESTIMATED_START_DATE, @ESTIMATED_END_DATE, @STATUS, @PRIORITY, @IS_TEMPLATE, @EXCHANGE_FOLDER;
  end
GO
