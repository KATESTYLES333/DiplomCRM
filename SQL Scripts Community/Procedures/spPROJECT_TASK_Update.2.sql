...
as
  begin
	...
	exec dbo.spPROJECT_TASKS_Update @ID out, @MODIFIED_USER_ID, @ASSIGNED_USER_ID, @NAME, @STATUS, @DATE_TIME_DUE, @DATE_TIME_START, @PARENT_ID, @PRIORITY, @DESCRIPTION, @ORDER_NUMBER, @TASK_NUMBER, @DEPENDS_ON_ID, @MILESTONE_FLAG, @ESTIMATED_EFFORT, @ACTUAL_EFFORT, @UTILIZATION, @PERCENT_COMPLETE, @TEAM_ID, @TEAM_SET_LIST;
  end
GO
