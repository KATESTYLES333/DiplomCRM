...
if not exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spQUOTES_CONTACTS_Update' and ROUTINE_TYPE = 'PROCEDURE') begin -- then
	exec('Create Procedure dbo.spQUOTES_CONTACTS_Update
...
as
  begin
	...
	exec('Grant Execute on dbo.spQUOTES_CONTACTS_Update to public');
end -- if;
GO
