...
-- #endif MySQL */
	...
	while @@FETCH_STATUS = 0 and @@ERROR = 0 begin -- do
		...
		-- 03/22/2013 Paul.  Add REPEAT fields. 
		-- 12/23/2013 Paul.  Add SMS_REMINDER_TIME. 
		exec dbo.spCALLS_Update @CALL_ID out, @MODIFIED_USER_ID, @ASSIGNED_USER_ID, @CALL_SUBJECT, @DURATION_HOURS, @DURATION_MINUTES, @DATE_TIME, @PARENT_TYPE, @PARENT_ID, @STATUS, @DIRECTION, @REMINDER_TIME, @DESCRIPTION, @INVITEE_LIST, @TEAM_ID, @TEAM_SET_LIST, @EMAIL_REMINDER_TIME, @ALL_DAY_EVENT, @REPEAT_TYPE, @REPEAT_INTERVAL, @REPEAT_DOW, @REPEAT_UNTIL, @REPEAT_COUNT, @SMS_REMINDER_TIME;
