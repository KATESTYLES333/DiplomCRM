...
as
  begin
	...
	exec dbo.spPROSPECT_LISTS_Update @ID out, @MODIFIED_USER_ID, @ASSIGNED_USER_ID, @NAME, @DESCRIPTION, @PARENT_TYPE, @PARENT_ID, @LIST_TYPE, @DOMAIN_NAME, @TEAM_ID, @TEAM_SET_LIST, @DYNAMIC_LIST;
  end
GO
