...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Project.SearchAdvanced' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBlank        'Project.SearchAdvanced'  ,  5, null;
end else begin
	exec dbo.spEDITVIEWS_FIELDS_CnvAutoComplete 'Project.SearchAdvanced'  ,  0, 'Project.LBL_NAME'                       , 'NAME'                       , 0, null, 100, 25, 'Project', null;
	if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Project.SearchAdvanced' and DATA_FIELD = 'ESTIMATED_START_DATE' and DELETED = 0) begin -- then
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'SmsMessages.SearchBasic' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsAutoComplete 'SmsMessages.SearchBasic'   ,  0, 'SmsMessages.LBL_NAME'                   , 'NAME'                       , 0, null, 140, 25, null, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'SmsMessages.SearchAdvanced' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsAutoComplete 'SmsMessages.SearchAdvanced',  0, 'SmsMessages.LBL_NAME'                   , 'NAME'                       , 0, null, 140, 25, null, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'TwitterMessages.SearchBasic' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsAutoComplete 'TwitterMessages.SearchBasic'   ,  0, 'TwitterMessages.LBL_NAME'                   , 'NAME'                       , 0, null, 140, 25, null, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'TwitterMessages.SearchAdvanced' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsAutoComplete 'TwitterMessages.SearchAdvanced',  0, 'TwitterMessages.LBL_NAME'                   , 'NAME'                       , 0, null, 140, 25, null, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'ChatChannels.SearchPopup' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_InsertOnly             'ChatChannels.SearchPopup'      , 'Accounts', 'vwCHAT_CHANNELS_List', '15%', '35%', 2;
