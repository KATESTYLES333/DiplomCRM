...
if not exists (select * from SHORTCUTS where MODULE_NAME = 'DynamicLayout' and DELETED = 0) begin -- then
	exec dbo.spSHORTCUTS_InsertOnly null, 'DynamicLayout'         , 'DynamicLayout.LNK_LAYOUT_DETAILVIEWS'         , '~/Administration/DynamicLayout/DetailViews/default.aspx'      , 'Administration.gif'   , 1,  1, 'DynamicLayout'     , 'list';
	exec dbo.spSHORTCUTS_InsertOnly null, 'DynamicLayout'         , 'DynamicLayout.LNK_LAYOUT_EDITVIEWS'           , '~/Administration/DynamicLayout/EditViews/default.aspx'        , 'Administration.gif'   , 1,  2, 'DynamicLayout'     , 'list';
	exec dbo.spSHORTCUTS_InsertOnly null, 'DynamicLayout'         , 'DynamicLayout.LNK_LAYOUT_GRIDVIEWS'           , '~/Administration/DynamicLayout/GridViews/default.aspx'        , 'Administration.gif'   , 1,  3, 'DynamicLayout'     , 'list';
	exec dbo.spSHORTCUTS_InsertOnly null, 'DynamicLayout'         , 'DynamicLayout.LNK_LAYOUT_RELATIONSHIPS'       , '~/Administration/DynamicLayout/Relationships/default.aspx'    , 'Administration.gif'   , 1,  4, 'DynamicLayout'     , 'list';
	exec dbo.spSHORTCUTS_InsertOnly null, 'DynamicLayout'         , 'DynamicLayout.LNK_LAYOUT_EDIT_RELATIONSHIPS'  , '~/Administration/DynamicLayout/EditRelationships/default.aspx', 'Administration.gif'   , 1,  5, 'DynamicLayout'     , 'list';
end else begin
