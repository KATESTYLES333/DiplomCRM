...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Accounts.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Search'          , 5, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Search'          , 6, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end else begin
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Bugs.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Search'              , 1, 'Bugs.LBL_LIST_NUMBER'                     , 'BUG_NUMBER'      , 'BUG_NUMBER'      , '50%';
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Cases.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Search'             , 6, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Search'             , 7, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end else begin
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Contacts.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Search'          , 2, 'Contacts.LBL_LIST_TITLE'                  , 'TITLE'           , 'TITLE'           , '15%';
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Search'          , 6, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Search'          , 7, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end else begin
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Leads.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Search'             , 6, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Search'             , 7, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Opportunities.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Search'     , 6, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Search'     , 7, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Project.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Search'           , 4, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Search'           , 5, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Prospects.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Search'         , 5, 'Teams.LBL_LIST_TEAM'                      , 'TEAM_NAME'       , 'TEAM_NAME'       , '10%';
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Search'         , 6, '.LBL_LIST_ASSIGNED_USER'                  , 'ASSIGNED_TO_NAME', 'ASSIGNED_TO_NAME', '10%';
end -- if;
GO
