...
exec dbo.spFIELD_VALIDATORS_InsertRegEx null, 'Email Address', '^(([A-Za-z0-9]+_+)|([A-Za-z0-9]+\-+)|([A-Za-z0-9]+\.+)|([A-Za-z0-9]+\++))*[A-Za-z0-9]+@((\w+\-+)|(\w+\.))*\w{1,63}\.[a-zA-Z]{2,6}$';
...
exec dbo.spFIELD_VALIDATORS_InsertRegEx null, 'Integer', '(^\d*\.?\d*[0-9]+\d*$)|(^[0-9]+\d*\.\d*$)';
