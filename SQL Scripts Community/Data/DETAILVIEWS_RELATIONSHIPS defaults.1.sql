...
-- 11/30/2012 Paul.  Use separate panels for Open Activities and History Activities as the HTML5 Offline Client does not allow for a single Activities panel that combines both. 
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Accounts.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Contacts'         , 'Contacts'           ,  2, 'Contacts.LBL_MODULE_NAME'         , 'vwACCOUNTS_CONTACTS'          , 'ACCOUNT_ID', 'CONTACT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Opportunities'    , 'Opportunities'      ,  3, 'Opportunities.LBL_MODULE_NAME'    , 'vwACCOUNTS_OPPORTUNITIES'     , 'ACCOUNT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Leads'            , 'Leads'              ,  4, 'Leads.LBL_MODULE_NAME'            , 'vwACCOUNTS_LEADS'             , 'ACCOUNT_ID', 'LEAD_NAME'    , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Cases'            , 'Cases'              ,  5, 'Cases.LBL_MODULE_NAME'            , 'vwACCOUNTS_CASES'             , 'ACCOUNT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Accounts'         , 'MemberOrganizations',  6, 'Accounts.LBL_MODULE_NAME'         , 'vwACCOUNTS_MEMBERS'           , 'ACCOUNT_ID', 'ACCOUNT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Bugs'             , 'Bugs'               ,  7, 'Bugs.LBL_MODULE_NAME'             , 'vwACCOUNTS_BUGS'              , 'ACCOUNT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Project'          , 'Projects'           ,  8, 'Project.LBL_MODULE_NAME'          , 'vwACCOUNTS_PROJECTS'          , 'ACCOUNT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.DetailView'      , 'Documents'        , 'Documents'          ,  9, 'Documents.LBL_MODULE_NAME'        , 'vwACCOUNTS_DOCUMENTS'         , 'ACCOUNT_ID', 'DOCUMENT_NAME', 'asc';
end else begin
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'ACLRoles.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ACLRoles.DetailView'      , 'Users'            , 'Users'              ,  0, 'Users.LBL_MODULE_NAME'            , null, null, null, null;
end -- if;
GO
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Bugs.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Bugs.DetailView'          , 'Contacts'         , 'Contacts'           ,  2, 'Contacts.LBL_MODULE_NAME'         , 'vwBUGS_CONTACTS'          , 'BUG_ID', 'CONTACT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Bugs.DetailView'          , 'Accounts'         , 'Accounts'           ,  3, 'Accounts.LBL_MODULE_NAME'         , 'vwBUGS_ACCOUNTS'          , 'BUG_ID', 'ACCOUNT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Bugs.DetailView'          , 'Cases'            , 'Cases'              ,  4, 'Cases.LBL_MODULE_NAME'            , 'vwBUGS_CASES'             , 'BUG_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Bugs.DetailView'          , 'Documents'        , 'Documents'          ,  5, 'Documents.LBL_MODULE_NAME'        , 'vwBUGS_DOCUMENTS'         , 'BUG_ID', 'DOCUMENT_NAME', 'asc';
end else begin
	-- 09/09/2012 Paul.  Add Documents relationship to Bugs, Cases and Quotes. 
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Campaigns.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Campaigns.DetailView'     , 'ProspectLists'    , 'ProspectLists'      ,  0, 'ProspectLists.LBL_MODULE_NAME'       , 'vwCAMPAIGNS_PROSPECT_LISTS' , 'CAMPAIGN_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Campaigns.DetailView'     , 'CampaignTrackers' , 'CampaignTrackers'   ,  1, 'CampaignTrackers.LBL_MODULE_NAME'    , 'vwCAMPAIGNS_CAMPAIGN_TRKRS' , 'CAMPAIGN_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Campaigns.DetailView'     , 'EmailMarketing'   , 'EmailMarketing'     ,  2, 'EmailMarketing.LBL_MODULE_NAME'      , 'vwCAMPAIGNS_EMAIL_MARKETING', 'CAMPAIGN_ID', 'DATE_START'  , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Campaigns.DetailView'     , 'CallMarketing'    , 'CallMarketing'      ,  3, 'CallMarketing.LBL_MODULE_NAME'       , 'vwCAMPAIGNS_CALL_MARKETING' , 'CAMPAIGN_ID', 'DATE_START'  , 'desc';
end else begin
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Cases.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Cases.DetailView'         , 'Contacts'         , 'Contacts'           ,  2, 'Contacts.LBL_MODULE_NAME'         , 'vwCASES_CONTACTS'          , 'CASE_ID', 'CONTACT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Cases.DetailView'         , 'Bugs'             , 'Bugs'               ,  3, 'Bugs.LBL_MODULE_NAME'             , 'vwCASES_BUGS'              , 'CASE_ID', 'BUG_NAME'     , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Cases.DetailView'         , 'Threads'          , 'Threads'            ,  4, 'Threads.LBL_MODULE_NAME'          , 'vwCASES_THREADS'           , 'CASE_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Cases.DetailView'         , 'Documents'        , 'Documents'          ,  5, 'Documents.LBL_MODULE_NAME'        , 'vwCASES_DOCUMENTS'         , 'CASE_ID', 'DOCUMENT_NAME', 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Cases.DetailView'         , 'Project'          , 'Projects'           ,  6, 'Project.LBL_MODULE_NAME'          , 'vwCASES_PROJECTS'          , 'CASE_ID', 'ESTIMATED_START_DATE', 'asc';
end else begin
...
-- 11/30/2012 Paul.  Use separate panels for Open Activities and History Activities as the HTML5 Offline Client does not allow for a single Activities panel that combines both. 
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Contacts.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Leads'            , 'Leads'              ,  2, 'Leads.LBL_MODULE_NAME'            , 'vwCONTACTS_LEADS'             , 'CONTACT_ID', 'LEAD_NAME'    , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Opportunities'    , 'Opportunities'      ,  3, 'Opportunities.LBL_MODULE_NAME'    , 'vwCONTACTS_OPPORTUNITIES'     , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Cases'            , 'Cases'              ,  4, 'Cases.LBL_MODULE_NAME'            , 'vwCONTACTS_CASES'             , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Bugs'             , 'Bugs'               ,  5, 'Bugs.LBL_MODULE_NAME'             , 'vwCONTACTS_BUGS'              , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Contacts'         , 'DirectReports'      ,  6, 'Contacts.LBL_MODULE_NAME'         , 'vwCONTACTS_DIRECT_REPORTS'    , 'CONTACT_ID', 'DIRECT_REPORT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Project'          , 'Projects'           ,  7, 'Project.LBL_MODULE_NAME'          , 'vwCONTACTS_PROJECTS'          , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	-- exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'   , 'CampaignLog'      , 'CampaignLog'        ,  8, 'CampaignLog.LBL_MODULE_NAME'      , 'vwCONTACTS_CAMPAIGN_LOG'      , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'ProspectLists'    , 'ProspectLists'      ,  8, 'ProspectLists.LBL_MODULE_NAME'    , 'vwCONTACTS_PROSPECT_LISTS'    , 'CONTACT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Contacts.DetailView'      , 'Documents'        , 'Documents'          ,  9, 'Documents.LBL_MODULE_NAME'        , 'vwCONTACTS_DOCUMENTS'         , 'CONTACT_ID', 'DOCUMENT_NAME', 'asc';
end else begin
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Documents.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Documents'        , 'DocumentRevisions'  ,  0, 'Documents.LBL_MODULE_NAME'    , 'vwDOCUMENT_REVISIONS'     , 'DOCUMENT_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Accounts'         , 'Accounts'           ,  1, 'Accounts.LBL_MODULE_NAME'     , 'vwDOCUMENTS_ACCOUNTS'     , 'DOCUMENT_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Contacts'         , 'Contacts'           ,  2, 'Contacts.LBL_MODULE_NAME'     , 'vwDOCUMENTS_CONTACTS'     , 'DOCUMENT_ID', 'CONTACT_NAME', 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Leads'            , 'Leads'              ,  3, 'Leads.LBL_MODULE_NAME'        , 'vwDOCUMENTS_LEADS'        , 'DOCUMENT_ID', 'LEAD_NAME'   , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Opportunities'    , 'Opportunities'      ,  4, 'Opportunities.LBL_MODULE_NAME', 'vwDOCUMENTS_OPPORTUNITIES', 'DOCUMENT_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Bugs'             , 'Bugs'               ,  5, 'Bugs.LBL_MODULE_NAME'         , 'vwDOCUMENTS_BUGS'         , 'DOCUMENT_ID', 'DATE_ENTERED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Documents.DetailView'     , 'Cases'            , 'Cases'              ,  6, 'Cases.LBL_MODULE_NAME'        , 'vwDOCUMENTS_CASES'        , 'DOCUMENT_ID', 'DATE_ENTERED', 'desc';
end else begin
...
-- 11/30/2012 Paul.  Use separate panels for Open Activities and History Activities as the HTML5 Offline Client does not allow for a single Activities panel that combines both. 
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Leads.DetailView' and DELETED = 0) begin -- then
	...
	-- exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Leads.DetailView'    , 'CampaignLog'      , 'CampaignLog'        ,  2, 'CampaignLog.LBL_MODULE_NAME'      , 'vwLEADS_CAMPAIGN_LOG'      , 'LEAD_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Leads.DetailView'       , 'Threads'          , 'Threads'            ,  2, 'Threads.LBL_MODULE_NAME'          , 'vwLEADS_THREADS'           , 'LEAD_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Leads.DetailView'       , 'ProspectLists'    , 'ProspectLists'      ,  3, 'ProspectLists.LBL_MODULE_NAME'    , 'vwLEADS_PROSPECT_LISTS'    , 'LEAD_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Leads.DetailView'       , 'Documents'        , 'Documents'          ,  4, 'Documents.LBL_MODULE_NAME'        , 'vwLEADS_DOCUMENTS'         , 'LEAD_ID', 'DOCUMENT_NAME', 'asc';
end else begin
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Opportunities.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Opportunities.DetailView' , 'Leads'            , 'Leads'              ,  2, 'Leads.LBL_MODULE_NAME'            , 'vwOPPORTUNITIES_LEADS'             , 'OPPORTUNITY_ID', 'LEAD_NAME'    , 'asc';
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'ProjectTask.DetailView' and DELETED = 0) begin -- then
	...
	--exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProjectTask.DetailView'   , 'Activities'       , 'Activities'         ,  0, 'Activities.LBL_MODULE_NAME'       , 'vwPROJECTS_ACTIVITIES'        , 'PROJECT_TASK_ID', 'DATE_MODIFIED', 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProjectTask.DetailView'   , 'Activities'       , 'ActivitiesOpen'     ,  0, 'Activities.LBL_OPEN_ACTIVITIES'   , 'vwPROJECTS_ACTIVITIES_OPEN'   , 'PROJECT_TASK_ID', 'DATE_DUE'     , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProjectTask.DetailView'   , 'Activities'       , 'ActivitiesHistory'  ,  1, 'Activities.LBL_HISTORY'           , 'vwPROJECTS_ACTIVITIES_HISTORY', 'PROJECT_TASK_ID', 'DATE_MODIFIED', 'desc';
end else begin
	-- 08/13/2009 Paul.  All the user to reorder the activities panels by creating separate controls for open and history. 
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'Prospects.DetailView' and DELETED = 0) begin -- then
	...
	-- exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Prospects.DetailView'    , 'CampaignLog'      , 'CampaignLog'        ,  2, 'CampaignLog.LBL_MODULE_NAME'      , 'vwPROSPECTS_CAMPAIGN_LOG'      , 'PROSPECT_ID', 'DATE_ENTERED' , 'desc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'Prospects.DetailView'       , 'ProspectLists'    , 'ProspectLists'      ,  2, 'ProspectLists.LBL_MODULE_NAME'    , 'vwPROSPECTS_PROSPECT_LISTS'    , 'PROSPECT_ID', 'DATE_ENTERED' , 'desc';
end else begin
...
if not exists(select * from DETAILVIEWS_RELATIONSHIPS where DETAIL_NAME = 'ProspectLists.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProspectLists.DetailView' , 'Prospects'        , 'Prospects'          ,  0, 'Prospects.LBL_MODULE_NAME'        , 'vwPROSPECT_LISTS_PROSPECTS'      , 'PROSPECT_LIST_ID', 'PROSPECT_NAME', 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProspectLists.DetailView' , 'Contacts'         , 'Contacts'           ,  1, 'Contacts.LBL_MODULE_NAME'         , 'vwPROSPECT_LISTS_CONTACTS'       , 'PROSPECT_LIST_ID', 'CONTACT_NAME' , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProspectLists.DetailView' , 'Leads'            , 'Leads'              ,  2, 'Leads.LBL_MODULE_NAME'            , 'vwPROSPECT_LISTS_LEADS'          , 'PROSPECT_LIST_ID', 'LEAD_NAME'    , 'asc';
	exec dbo.spDETAILVIEWS_RELATIONSHIPS_InsertOnly 'ProspectLists.DetailView' , 'Users'            , 'Users'              ,  3, 'Users.LBL_MODULE_NAME'            , 'vwPROSPECT_LISTS_USERS'          , 'PROSPECT_LIST_ID', 'FULL_NAME'    , 'asc';
end -- if;
GO
