...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Currencies.EditView' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton 'Currencies.EditView'             , 1, null              , null  , null              , null, 'Clear'                  , null, '.LBL_CLEAR_BUTTON_LABEL'                      , '.LBL_CLEAR_BUTTON_TITLE'                     , '.LBL_CLEAR_BUTTON_KEY'                     , null, null;
end -- if;
GO
