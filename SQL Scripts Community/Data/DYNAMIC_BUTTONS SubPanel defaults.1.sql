...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Accounts.Contacts' and COMMAND_NAME like '%.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Accounts.Activities.Open'        , 4, 'Accounts'        , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Bugs.Contacts' and COMMAND_NAME like '%.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Bugs.Activities.Open'            , 4, 'Bugs'            , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Cases.Project' and COMMAND_NAME like '%.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Cases.Activities.Open'           , 4, 'Cases'           , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'EmailMarketing.ProspectLists' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsPopup     'EmailMarketing.ProspectLists'    , 0, 'EmailMarketing'  , 'edit', 'ProspectList'    , 'list', 'ProspectListPopup();'    , null, '.LBL_SELECT_BUTTON_LABEL'                    , '.LBL_SELECT_BUTTON_TITLE'                    , null, null, null;
end else begin
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Opportunities.Contacts' and COMMAND_NAME like '%.Search' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Opportunities.Activities.Open'   , 4, 'Opportunities'   , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
...
--	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Project.Accounts'                , 0, 'Project'         , 'edit', 'Accounts'        , 'edit', 'Accounts.Create'         , null, '.LBL_NEW_BUTTON_LABEL'                       , '.LBL_NEW_BUTTON_TITLE'                       , null, null, null;
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'Project.Activities.Open'         , 3, 'Project'         , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'ProjectTask.Activities.Open' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton    'ProjectTask.Activities.Open'     , 4, 'ProjectTask'     , 'view', 'Emails'          , 'list', 'Activities.SearchOpen'   , null, '.LBL_SEARCH_BUTTON_LABEL'                    , '.LBL_SEARCH_BUTTON_TITLE'                    , null, null, null;
