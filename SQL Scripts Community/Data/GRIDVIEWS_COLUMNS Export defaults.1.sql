...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Accounts.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 28, 'Accounts.LBL_LIST_DATE_ENTERED'               , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 29, 'Accounts.LBL_LIST_DATE_MODIFIED'              , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 30, 'Accounts.LBL_LIST_DESCRIPTION'                , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 31, 'Accounts.LBL_LIST_TEAM_NAME'                  , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 32, 'Accounts.LBL_LIST_ASSIGNED_TO_NAME'           , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 33, 'Accounts.LBL_LIST_CREATED_BY_NAME'            , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Accounts.Export'         , 34, 'Accounts.LBL_LIST_MODIFIED_BY_NAME'           , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Bugs.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 11, 'Bugs.LBL_LIST_DATE_ENTERED'                   , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 12, 'Bugs.LBL_LIST_DATE_MODIFIED'                  , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 15, 'Bugs.LBL_LIST_TEAM_NAME'                      , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 16, 'Bugs.LBL_LIST_ASSIGNED_TO_NAME'               , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 17, 'Bugs.LBL_LIST_CREATED_BY_NAME'                , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Bugs.Export'             , 18, 'Bugs.LBL_LIST_MODIFIED_BY_NAME'               , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Calls.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 11, 'Calls.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 12, 'Calls.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 13, 'Calls.LBL_LIST_DESCRIPTION'                   , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 14, 'Calls.LBL_LIST_TEAM_NAME'                     , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 15, 'Calls.LBL_LIST_ASSIGNED_TO_NAME'              , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 16, 'Calls.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Calls.Export'            , 17, 'Calls.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Cases.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            ,  6, 'Cases.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            ,  7, 'Cases.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            , 10, 'Cases.LBL_LIST_TEAM_NAME'                     , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            , 11, 'Cases.LBL_LIST_ASSIGNED_TO_NAME'              , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            , 12, 'Cases.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Cases.Export'            , 13, 'Cases.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Contacts.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 35, 'Contacts.LBL_LIST_DATE_ENTERED'               , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 36, 'Contacts.LBL_LIST_DATE_MODIFIED'              , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 37, 'Contacts.LBL_LIST_DESCRIPTION'                , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 38, 'Contacts.LBL_LIST_TEAM_NAME'                  , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 39, 'Contacts.LBL_LIST_ACCOUNT_NAME'               , 'ACCOUNT_NAME'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 40, 'Contacts.LBL_LIST_ASSIGNED_TO_NAME'           , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 41, 'Contacts.LBL_LIST_CREATED_BY_NAME'            , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Contacts.Export'         , 42, 'Contacts.LBL_LIST_MODIFIED_BY_NAME'           , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Documents.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Documents.Export'        ,  8, 'Documents.LBL_LIST_DATE_ENTERED'              , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Documents.Export'        ,  9, 'Documents.LBL_LIST_DATE_MODIFIED'             , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Documents.Export'        , 17, 'Documents.LBL_LIST_TEAM_NAME'                 , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Documents.Export'        , 18, 'Documents.LBL_LIST_CREATED_BY_NAME'           , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Documents.Export'        , 19, 'Documents.LBL_LIST_MODIFIED_BY_NAME'          , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Emails.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 13, 'Emails.LBL_LIST_DATE_ENTERED'                 , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 14, 'Emails.LBL_LIST_DATE_MODIFIED'                , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 17, 'Emails.LBL_LIST_TEAM_NAME'                    , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 18, 'Emails.LBL_LIST_ASSIGNED_TO_NAME'             , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 19, 'Emails.LBL_LIST_CREATED_BY_NAME'              , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Emails.Export'           , 20, 'Emails.LBL_LIST_MODIFIED_BY_NAME'             , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Employees.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Employees.Export'        , 28, 'Employees.LBL_LIST_DATE_ENTERED'              , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Employees.Export'        , 29, 'Employees.LBL_LIST_DATE_MODIFIED'             , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Employees.Export'        , 35, 'Employees.LBL_LIST_CREATED_BY_NAME'           , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Employees.Export'        , 36, 'Employees.LBL_LIST_MODIFIED_BY_NAME'          , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Leads.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 35, 'Leads.LBL_LIST_OPPORTUNITY_NAME'              , 'OPPORTUNITY_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 36, 'Leads.LBL_LIST_OPPORTUNITY_AMOUNT'            , 'OPPORTUNITY_AMOUNT'         , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 37, 'Leads.LBL_LIST_CAMPAIGN_NAME'                 , 'CAMPAIGN_NAME'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 38, 'Leads.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 39, 'Leads.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 43, 'Leads.LBL_LIST_TEAM_NAME'                     , 'TEAM_NAME'                  , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 45, 'Leads.LBL_LIST_ASSIGNED_TO_NAME'              , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 46, 'Leads.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Leads.Export'            , 47, 'Leads.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Meetings.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 11, 'Meetings.LBL_LIST_DATE_ENTERED'               , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 12, 'Meetings.LBL_LIST_DATE_MODIFIED'              , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 13, 'Meetings.LBL_LIST_DESCRIPTION'                , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 14, 'Meetings.LBL_LIST_TEAM_NAME'                  , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 15, 'Meetings.LBL_LIST_ASSIGNED_TO_NAME'           , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 16, 'Meetings.LBL_LIST_CREATED_BY_NAME'            , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Meetings.Export'         , 17, 'Meetings.LBL_LIST_MODIFIED_BY_NAME'           , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Notes.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Notes.Export'            ,  4, 'Notes.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Notes.Export'            ,  5, 'Notes.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Notes.Export'            , 14, 'Notes.LBL_LIST_TEAM_NAME'                     , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Notes.Export'            , 15, 'Notes.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Notes.Export'            , 16, 'Notes.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Opportunities.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 11, 'Opportunities.LBL_LIST_DATE_ENTERED'          , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 12, 'Opportunities.LBL_LIST_DATE_MODIFIED'         , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 16, 'Opportunities.LBL_LIST_TEAM_NAME'             , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 17, 'Opportunities.LBL_LIST_ASSIGNED_TO_NAME'      , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 18, 'Opportunities.LBL_LIST_CREATED_BY_NAME'       , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Opportunities.Export'    , 19, 'Opportunities.LBL_LIST_MODIFIED_BY_NAME'      , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Project.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          ,  9, 'Project.LBL_LIST_DATE_ENTERED'                , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 10, 'Project.LBL_LIST_DATE_MODIFIED'               , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 11, 'Project.LBL_LIST_DESCRIPTION'                 , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 12, 'Project.LBL_LIST_TEAM_NAME'                   , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 13, 'Project.LBL_LIST_ASSIGNED_TO_NAME'            , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 14, 'Project.LBL_LIST_CREATED_BY_NAME'             , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Project.Export'          , 15, 'Project.LBL_LIST_MODIFIED_BY_NAME'            , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'ProjectTask.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 15, 'ProjectTask.LBL_LIST_DATE_ENTERED'            , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 16, 'ProjectTask.LBL_LIST_DATE_MODIFIED'           , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 20, 'ProjectTask.LBL_LIST_TEAM_NAME'               , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 21, 'ProjectTask.LBL_LIST_ASSIGNED_TO_NAME'        , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 22, 'ProjectTask.LBL_LIST_CREATED_BY_NAME'         , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'ProjectTask.Export'      , 23, 'ProjectTask.LBL_LIST_MODIFIED_BY_NAME'        , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Prospects.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 32, 'Prospects.LBL_LIST_DATE_ENTERED'              , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 33, 'Prospects.LBL_LIST_DATE_MODIFIED'             , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 34, 'Prospects.LBL_LIST_DESCRIPTION'               , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 35, 'Prospects.LBL_LIST_TEAM_NAME'                 , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 36, 'Prospects.LBL_LIST_ASSIGNED_TO_NAME'          , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 37, 'Prospects.LBL_LIST_CREATED_BY_NAME'           , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Prospects.Export'        , 38, 'Prospects.LBL_LIST_MODIFIED_BY_NAME'          , 'MODIFIED_BY_NAME'           , null, null;
end -- if;
GO
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Tasks.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 15, 'Tasks.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 16, 'Tasks.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 17, 'Tasks.LBL_LIST_DESCRIPTION'                   , 'DESCRIPTION'                , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 18, 'Tasks.LBL_LIST_TEAM_NAME'                     , 'TEAM_NAME'                  , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 19, 'Tasks.LBL_LIST_ASSIGNED_TO_NAME'              , 'ASSIGNED_TO_NAME'           , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 20, 'Tasks.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Tasks.Export'            , 21, 'Tasks.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Users.Export' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Users.Export'            , 28, 'Users.LBL_LIST_DATE_ENTERED'                  , 'DATE_ENTERED'               , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Users.Export'            , 29, 'Users.LBL_LIST_DATE_MODIFIED'                 , 'DATE_MODIFIED'              , null, null;
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Users.Export'            , 34, 'Users.LBL_LIST_CREATED_BY_NAME'               , 'CREATED_BY_NAME'            , null, null;
	exec dbo.spGRIDVIEWS_COLUMNS_InsBound     'Users.Export'            , 35, 'Users.LBL_LIST_MODIFIED_BY_NAME'              , 'MODIFIED_BY_NAME'           , null, null;
