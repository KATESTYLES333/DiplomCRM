...
exec dbo.spLANGUAGES_InsertOnly N'cs-CZ'     ,  1029, 0, N'ceština (Ceská republika)', N'Czech (Czech Republic)';
...
exec dbo.spLANGUAGES_InsertOnly N'ro-RO'     ,  1048, 0, N'româna (România)', N'Romanian (Romania)';
exec dbo.spLANGUAGES_InsertOnly N'ru-RU'     ,  1049, 0, N'??????? (??????)', N'Russian (Russia)';
exec dbo.spLANGUAGES_InsertOnly N'sk-SK'     ,  1051, 0, N'slovencina (Slovenská republika)', N'Slovak (Slovakia)';
...
exec dbo.spLANGUAGES_InsertOnly N'vi-VN'     ,  1066, 0, N'Tiê´ng Viê?t Nam (Viê?t Nam)', N'Vietnamese (Viet Nam)';
GO
