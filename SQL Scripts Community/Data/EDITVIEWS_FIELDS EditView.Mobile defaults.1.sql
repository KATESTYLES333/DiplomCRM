...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Accounts.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Accounts.EditView.Mobile'       , 28, 'Accounts.LBL_POSTAL_CODE'               , 'BILLING_ADDRESS_POSTALCODE' , 0, 3,  20, 15, null;
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Accounts.EditView.Mobile'       , 29, 'Accounts.LBL_POSTAL_CODE'               , 'SHIPPING_ADDRESS_POSTALCODE', 0, 4,  20, 15, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Contacts.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Contacts.EditView.Mobile'       , 33, 'Contacts.LBL_POSTAL_CODE'               , 'PRIMARY_ADDRESS_POSTALCODE' , 0, 3,  20, 15, null;
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Contacts.EditView.Mobile'       , 34, 'Contacts.LBL_POSTAL_CODE'               , 'ALT_ADDRESS_POSTALCODE'     , 0, 4,  20, 15, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Employees.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Employees.EditView.Mobile'      , 22, 'Employees.LBL_POSTAL_CODE'              , 'ADDRESS_POSTALCODE'         , 0, 8,  20, 10, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Prospects.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Prospects.EditView.Mobile'      , 33, 'Prospects.LBL_POSTAL_CODE'              , 'PRIMARY_ADDRESS_POSTALCODE' , 0, 3,  20, 15, null;
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Prospects.EditView.Mobile'      , 34, 'Prospects.LBL_POSTAL_CODE'              , 'ALT_ADDRESS_POSTALCODE'     , 0, 4,  20, 15, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'Users.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_FIELDS_InsBound       'Users.EditView.Mobile'          , 22, 'Users.LBL_POSTAL_CODE'                  , 'ADDRESS_POSTALCODE'         , 0, 8,  20, 10, null;
...
if not exists(select * from EDITVIEWS_FIELDS where EDIT_NAME = 'CampaignTrackers.EditView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_InsertOnly            'CampaignTrackers.DetailView', 'CampaignTrackers', 'vwCAMPAIGN_TRKRS_Edit', '15%', '35%', null;
