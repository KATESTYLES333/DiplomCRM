...
if not exists(select * from GRIDVIEWS_COLUMNS where GRID_NAME = 'Accounts.Products' and DELETED = 0) begin -- then
	...
	exec dbo.spGRIDVIEWS_COLUMNS_InsHyperLink 'Accounts.Products'               , 1, 'Products.LBL_LIST_NAME'                   , 'PRODUCT_NAME'              , 'PRODUCT_NAME'              , '20%', 'listViewTdLinkS1', 'PRODUCT_ID', '~/Products/view.aspx?id={0}', null, 'Products', 'ASSIGNED_USER_ID';
