...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Accounts.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Accounts.MassUpdate'      , -1, 'Accounts'      , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Accounts'     , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Bugs.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Bugs.MassUpdate'          , -1, 'Bugs'          , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Bugs'         , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Calls.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then                                                       
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Calls.MassUpdate'         , -1, 'Calls'         , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Calls'        , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Campaigns.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Campaigns.MassUpdate'     , -1, 'Campaigns'     , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Campaigns'    , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Cases.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Cases.MassUpdate'         , -1, 'Cases'         , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Cases'        , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Contacts.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Contacts.MassUpdate'      , -1, 'Contacts'      , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Contacts'     , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Documents.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Documents.MassUpdate'     , -1, 'Documents'     , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Documents'    , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Emails.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Emails.MassUpdate'        , -1, 'Emails'        , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Emails'       , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Leads.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Leads.MassUpdate'         , -1, 'Leads'         , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Leads'        , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Meetings.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Meetings.MassUpdate'      , -1, 'Meetings'      , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Meetings'     , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Notes.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Notes.MassUpdate'         , -1, 'Notes'         , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Notes'        , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Opportunities.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Opportunities.MassUpdate' , -1, 'Opportunities' , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Opportunities', null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Project.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Project.MassUpdate'       , -1, 'Project'       , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Project'      , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'ProjectTask.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'ProjectTask.MassUpdate'   , -1, 'ProjectTask'   , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=ProjectTask'  , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'ProspectLists.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'ProspectLists.MassUpdate' , -1, 'ProspectLists' , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=ProspectLists', null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Prospects.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Prospects.MassUpdate'     , -1, 'Prospects'     , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Prospects'    , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Releases.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Releases.MassUpdate'      , -1, 'Releases'      , 'edit'  , null, null, 'RulesWizard', '../../RulesWizard/edit.aspx?Module=Releases', null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end else begin
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Tasks.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Tasks.MassUpdate'         , -1, 'Tasks'         , 'edit'  , null, null, 'RulesWizard', '../RulesWizard/edit.aspx?Module=Tasks', null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end else begin
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Terminology.MassUpdate' and COMMAND_NAME = 'RulesWizard' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Terminology.MassUpdate'   , -1, 'Terminology'   , 'edit'  , null, null, 'RulesWizard', '../../RulesWizard/edit.aspx?Module=Terminology'  , null, 'RulesWizard.LBL_RULES_WIZARD_BUTTON_LABEL', 'RulesWizard.LBL_RULES_WIZARD_BUTTON_TITLE', null, null, null, null;
end -- if;
GO
