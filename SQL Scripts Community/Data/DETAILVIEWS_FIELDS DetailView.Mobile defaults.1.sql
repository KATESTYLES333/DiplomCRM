...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Bugs.DetailView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Bugs.DetailView.Mobile'   ,  5, null;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Cases.DetailView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Cases.DetailView.Mobile'  ,  8, null;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Contacts.DetailView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Contacts.DetailView.Mobile',  2, null;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Leads.DetailView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Leads.DetailView.Mobile'   , 10, null;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Opportunities.DetailView.Mobile' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile',  3, 'Opportunities.LBL_DATE_CLOSED'     , 'DATE_CLOSED'                      , '{0:d}'      , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList 'Opportunities.DetailView.Mobile',  4, 'Opportunities.LBL_TYPE'            , 'OPPORTUNITY_TYPE'                 , '{0}'        , 'opportunity_type_dom', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile',  5, 'Opportunities.LBL_NEXT_STEP'       , 'NEXT_STEP'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList 'Opportunities.DetailView.Mobile',  6, 'Opportunities.LBL_LEAD_SOURCE'     , 'LEAD_SOURCE'                      , '{0}'        , 'lead_source_dom'     , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList 'Opportunities.DetailView.Mobile',  7, 'Opportunities.LBL_SALES_STAGE'     , 'SALES_STAGE'                      , '{0}'        , 'sales_stage_dom'     , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile',  8, 'Teams.LBL_TEAM'                    , 'TEAM_NAME'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile',  9, 'Opportunities.LBL_PROBABILITY'     , 'PROBABILITY'                      , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile', 10, '.LBL_ASSIGNED_TO'                  , 'ASSIGNED_TO_NAME'                 , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile', 11, '.LBL_DATE_MODIFIED'                , 'DATE_MODIFIED .LBL_BY MODIFIED_BY_NAME', '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Opportunities.DetailView.Mobile', 12, null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Opportunities.DetailView.Mobile', 13, '.LBL_DATE_ENTERED'                 , 'DATE_ENTERED .LBL_BY CREATED_BY_NAME'  , '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly   'Opportunities.DetailView.Mobile', 14, 'TextBox', 'Opportunities.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end -- if;
GO
