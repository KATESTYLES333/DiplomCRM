...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Users.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButton     'Users.DetailView'               , 4, 'Users'           , null, null, null, 'ResetDefaults'           , null, 'Employees.LBL_RESET_PREFERENCES'             , 'Employees.LBL_RESET_PREFERENCES'             , null, null, null;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Contacts.DetailView' and URL_FORMAT = 'vCard.aspx?ID={0}' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Contacts.DetailView'             , 5, 'Contacts' , 'view', 'Contacts' , 'view', 'vCard' , 'vCard.aspx?ID={0}', 'ID', '.LBL_EXPORT_VCARD', '.LBL_EXPORT_VCARD', null, 'vCard', null, null;
end -- if;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Leads.DetailView' and URL_FORMAT = 'vCard.aspx?ID={0}' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Leads.DetailView'                , 5, 'Leads'    , 'view', 'Leads'    , 'view', 'vCard' , 'vCard.aspx?ID={0}', 'ID', '.LBL_EXPORT_VCARD', '.LBL_EXPORT_VCARD', null, 'vCard', null, null;
end -- if;
...
if not exists(select * from DYNAMIC_BUTTONS where VIEW_NAME = 'Prospects.DetailView' and URL_FORMAT = 'vCard.aspx?ID={0}' and DELETED = 0) begin -- then
	...
	exec dbo.spDYNAMIC_BUTTONS_InsButtonLink 'Prospects.DetailView'            , 5, 'Prospects', 'view', 'Prospects', 'view', 'vCard' , 'vCard.aspx?ID={0}', 'ID', '.LBL_EXPORT_VCARD', '.LBL_EXPORT_VCARD', null, 'vCard', null, null;
end -- if;
GO
