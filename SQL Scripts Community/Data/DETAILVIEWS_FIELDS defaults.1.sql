...
--	exec dbo.spDETAILVIEWS_FIELDS_InsJavaScript 'Accounts.DetailView',  1, null                              , 'NAME'                             , 'ID NAME'    , 'if (typeof(LinkedIn) != "undefined") new LinkedIn.CompanyInsiderPopup("spn{0}_NAME","{1}");', 'spn{0}_NAME', -1;
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 10, 'Accounts.LBL_OWNERSHIP'          , 'OWNERSHIP'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 11, 'Accounts.LBL_RATING'             , 'RATING'                           , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList  'Accounts.DetailView', 12, 'Accounts.LBL_INDUSTRY'           , 'INDUSTRY'                         , '{0}'        , 'industry_dom'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 13, 'Accounts.LBL_SIC_CODE'           , 'SIC_CODE'                         , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList  'Accounts.DetailView', 14, 'Accounts.LBL_TYPE'               , 'ACCOUNT_TYPE'                     , '{0}'        , 'account_type_dom'    , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 15, 'Accounts.LBL_ANNUAL_REVENUE'     , 'ANNUAL_REVENUE'                   , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 16, 'Teams.LBL_TEAM'                  , 'TEAM_NAME'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 17, '.LBL_DATE_MODIFIED'              , 'DATE_MODIFIED .LBL_BY MODIFIED_BY_NAME', '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 18, '.LBL_ASSIGNED_TO'                , 'ASSIGNED_TO_NAME'                 , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 19, '.LBL_DATE_ENTERED'               , 'DATE_ENTERED .LBL_BY CREATED_BY_NAME'  , '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 20, 'Accounts.LBL_BILLING_ADDRESS'    , 'BILLING_ADDRESS_HTML'             , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Accounts.DetailView', 21, 'Accounts.LBL_SHIPPING_ADDRESS'   , 'SHIPPING_ADDRESS_HTML'            , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly    'Accounts.DetailView', 22, 'TextBox', 'Accounts.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Bugs.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Bugs.DetailView'   , 14, null;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Contacts.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Contacts.DetailView',  0, 'Contacts.LBL_NAME'               , 'NAME'                             , '{0}'        , null;
...
--	exec dbo.spDETAILVIEWS_FIELDS_InsJavaScript 'Contacts.DetailView',  5, null                              , 'ACCOUNT_NAME'                     , 'ID ACCOUNT_NAME', 'if (typeof(LinkedIn) != "undefined") new LinkedIn.CompanyInsiderPopup("spn{0}_ACCOUNT_NAME","{1}");', 'spn{0}_ACCOUNT_NAME', -1;
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Contacts.DetailView', 24, 'Contacts.LBL_PRIMARY_ADDRESS'    , 'PRIMARY_ADDRESS_HTML'             , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Contacts.DetailView', 25, 'Contacts.LBL_ALTERNATE_ADDRESS'  , 'ALT_ADDRESS_HTML'                 , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly    'Contacts.DetailView', 26, 'TextBox', 'Contacts.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Documents.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly   'Documents.DetailView', 12, 'TextBox', 'Documents.LBL_DOC_DESCRIPTION', 'DESCRIPTION', '10,90', null, null, null, null, 3, null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Documents.DetailView', 13, 3;
	exec dbo.spDETAILVIEWS_FIELDS_InsHyperLink 'Documents.DetailView', 14, 'Documents.LBL_DOWNNLOAD_FILE'    , 'FILENAME'                        , '{0}'        , 'DOCUMENT_REVISION_ID'    , '~/Documents/Document.aspx?ID={0}', '_blank', 3;
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'EmailTemplates.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'EmailTemplates.DetailView',  8, 'EmailTemplates.LBL_BODY'         , 'BODY_HTML'                        , '{0}'        , 3;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Leads.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Leads.DetailView'   ,  8, 'Leads.LBL_NAME'                   , 'NAME'                             , '{0}'        , null;
...
--	exec dbo.spDETAILVIEWS_FIELDS_InsJavaScript 'Leads.DetailView'   , 13, null                               , 'ACCOUNT_NAME'                     , 'ID ACCOUNT_NAME', 'if (typeof(LinkedIn) != "undefined") new LinkedIn.CompanyInsiderPopup("spn{0}_ACCOUNT_NAME","{1}");', 'spn{0}_ACCOUNT_NAME', -1;
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Leads.DetailView'   , 26, 'Leads.LBL_PRIMARY_ADDRESS'        , 'PRIMARY_ADDRESS_HTML'             , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Leads.DetailView'   , 27, 'Leads.LBL_ALTERNATE_ADDRESS'      , 'ALT_ADDRESS_HTML'                 , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly    'Leads.DetailView'   , 28, 'TextBox', 'Leads.LBL_DESCRIPTION' , 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
--	exec dbo.spDETAILVIEWS_FIELDS_InsJavaScript 'Opportunities.DetailView',  3, null                                , 'ACCOUNT_NAME'                     , 'ID ACCOUNT_NAME', 'if (typeof(LinkedIn) != "undefined") new LinkedIn.CompanyInsiderPopup("spn{0}_ACCOUNT_NAME","{1}");', 'spn{0}_ACCOUNT_NAME', -1;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView',  3, 'Opportunities.LBL_DATE_CLOSED'     , 'DATE_CLOSED'                      , '{0:d}'      , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList  'Opportunities.DetailView',  4, 'Opportunities.LBL_TYPE'            , 'OPPORTUNITY_TYPE'                 , '{0}'        , 'opportunity_type_dom', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView',  5, 'Opportunities.LBL_NEXT_STEP'       , 'NEXT_STEP'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList  'Opportunities.DetailView',  6, 'Opportunities.LBL_LEAD_SOURCE'     , 'LEAD_SOURCE'                      , '{0}'        , 'lead_source_dom'     , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBoundList  'Opportunities.DetailView',  7, 'Opportunities.LBL_SALES_STAGE'     , 'SALES_STAGE'                      , '{0}'        , 'sales_stage_dom'     , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView',  8, 'Teams.LBL_TEAM'                    , 'TEAM_NAME'                        , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView',  9, 'Opportunities.LBL_PROBABILITY'     , 'PROBABILITY'                      , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView', 10, '.LBL_ASSIGNED_TO'                  , 'ASSIGNED_TO_NAME'                 , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView', 11, '.LBL_DATE_MODIFIED'                , 'DATE_MODIFIED .LBL_BY MODIFIED_BY_NAME', '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView', 12, '.LBL_LAST_ACTIVITY_DATE'           , 'LAST_ACTIVITY_DATE'               , '{0}'        , null;
	exec dbo.spDETAILVIEWS_FIELDS_InsHyperLink  'Opportunities.DetailView', 13, 'Opportunities.LBL_CAMPAIGN_NAME'   , 'CAMPAIGN_NAME'                    , '{0}'        , 'CAMPAIGN_ID'         , '~/Campaigns/view.aspx?ID={0}', null, null;
	exec dbo.spDETAILVIEWS_FIELDS_InsBound      'Opportunities.DetailView', 14, '.LBL_DATE_ENTERED'                 , 'DATE_ENTERED .LBL_BY CREATED_BY_NAME'  , '{0} {1} {2}', null;
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly    'Opportunities.DetailView', 15, 'TextBox', 'Opportunities.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
--	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Project.DetailView',  7, 'Project.LBL_TOTAL_ACTUAL_EFFORT'     , 'TOTAL_ACTUAL_EFFORT'              , '{0}'        , null;
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly   'Project.DetailView',  8, 'TextBox', 'Project.LBL_DESCRIPTION'  , 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'ProspectLists.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly   'ProspectLists.DetailView', 10, 'TextBox', 'ProspectLists.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Prospects.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBound     'Prospects.DetailView',  0, 'Prospects.LBL_NAME'               , 'NAME'                             , '{0}'        , null;
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsertOnly   'Prospects.DetailView', 28, 'TextBox', 'Prospects.LBL_DESCRIPTION', 'DESCRIPTION', null, null, null, null, null, 3, null;
end else begin
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Users.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsHyperLink 'Users.DetailView'   ,  7, 'Contacts.LBL_REPORTS_TO'         , 'REPORTS_TO_NAME'                  , '{0}'        , 'REPORTS_TO_ID'       , '~/Users/view.aspx?ID={0}', null, null;
...
if exists(select * from DETAILVIEWS_FIELDS where FIELD_TYPE = 'String' and DATA_FIELD = 'DESCRIPTION') begin -- then
...
if not exists(select * from DETAILVIEWS_FIELDS where DETAIL_NAME = 'Modules.DetailView' and DELETED = 0) begin -- then
	...
	exec dbo.spDETAILVIEWS_FIELDS_InsBlank     'Modules.DetailView' , 21, null;
end else begin
